...
class SubCat_Mens_shoes extends StatefulWidget {
  const SubCat_Mens_shoes({Key? key}) : super(key: key);

  @override
  State<SubCat_Mens_shoes> createState() => _SubCat_Mens_shoesState();
}

class _SubCat_Mens_shoesState extends State<SubCat_Mens_shoes> {
        ...
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                  ...
                  _productbycatid_controller
                          .mensshoes_userlist.value.productByCategory?.length ==
                      0
              ? Center(
                  child: Column(
                  children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.mensshoes_userlist.value.productByCategory?[index].title.toString()}",
                                    ...
                                    onTap: () {
                                      ...
                                      if (mainCatId == "174") {
                                        ...
                                        showModalBottomSheet(
                                            ...
                                            builder: (context) {
                                              return _buildAddtocartmensshoes(
                                                  context,
                                                  mainCatId,
                                                  productId);
                                            });
  ...
  Widget _buildAddtocartmensshoes(
