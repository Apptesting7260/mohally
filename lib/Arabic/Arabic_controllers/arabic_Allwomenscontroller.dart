...
class ArabicWomensAllProductController extends GetxController {
  final _api = AuthRepository();

  final rxRequestStatus = Status.LOADING.obs;
  final womens = ArabicMensAllProductModel().obs;
  RxString error = ''.obs;

  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setUserList(ArabicMensAllProductModel value) => womens.value = value;
  ...
  void WomensAllProductView() async {
    ...
    loading.value = true;
    Map data = {"cat_id": "134", "language_type": "Arabic"};
