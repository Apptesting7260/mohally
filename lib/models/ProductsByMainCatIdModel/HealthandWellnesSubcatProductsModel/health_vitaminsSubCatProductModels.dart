class Health_vitaminsSubcatProductsviewModel {
  Health_vitaminsSubcatProductsviewModel({
    this.status,
  ...
  Health_vitaminsSubcatProductsviewModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
