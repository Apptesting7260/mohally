...
class ALLSinglePageScreen_Electronics_Smartphones extends StatefulWidget {
  const ALLSinglePageScreen_Electronics_Smartphones({Key? key})
      : super(
          key: key,
        );

  @override
  State<ALLSinglePageScreen_Electronics_Smartphones> createState() =>
      _ALLSinglePageScreen_Electronics_SmartphonesState();
}

class _ALLSinglePageScreen_Electronics_SmartphonesState
    extends State<ALLSinglePageScreen_Electronics_Smartphones> {
  ...
  int selectedIndex = 0;
  EnglishAllSingleProductViewController productviewcontroller =
      EnglishAllSingleProductViewController();
  ...
  void initState() {
    super.initState();
    productviewcontroller.All_ProductApiHit();
          ...
          child: Scaffold(
            body: Container(
              ...
              child: productviewcontroller
                          .smartphone_userlist.value.productView ==
                      null
                  ? Center(
                      child: Padding(
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.smartphone_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                        ...
                        SizedBox(height: 14.v),
                        // Obx(() {
                        // var materialTags = productviewcontroller.smartphone_userlist
                        //     .value.productView?.productCatgories?.tags;
                        // var materialsubTags = productviewcontroller.smartphone_userlist
            ...
            child: Column(
              ...
              children: [
                ...
                _buildButtonOneHundredTen(
                    context,
                    selectedImageIndex,
                    productviewcontroller.smartphone_userlist.value.productView
                            ?.galleryUrl?.length ??
                        0),
                SizedBox(height: 10.v),
                Padding(
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemCount: productviewcontroller
                  .smartphone_userlist.value.productView?.galleryUrl?.length ??
              0,
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller.smartphone_userlist.value
      ...
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          String imageUrl = productviewcontroller
                  .smartphone_userlist.value.productView?.galleryUrl?[index] ??
              '';
          return SizedBox(
            height: Get.height * .1,
            //  width: 80.adaptSize,
          ...
          return CustomOutlinedButton(
            ...
            onPressed: () {
              Englishcartproductid = productviewcontroller
                  .smartphone_userlist.value.productView?.id
                  .toString();
              EnglishAddtocartColor = productviewcontroller.smartphone_userlist
                  .value.productView?.productDetails?.details?[0].ColorId
                  .toString();
              EnglishAddtocartprice = productviewcontroller.smartphone_userlist
                  .value.productView?.productDetails?.details?[index].price
                  .toString();
              EnglishAddtocartSize = productviewcontroller.smartphone_userlist
                  .value.productView?.productDetails?.details?[0].Model
                  .toString();
  ...
  Widget _buildcontentofimg1(BuildContext context) {
    return Column(
      children: [
        ...
        ListView.builder(
          shrinkWrap: true,
          itemCount: productviewcontroller.smartphone_userlist.value.productView
                  ?.productCatgories?.tags?.item?.length ??
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.smartphone_userlist.value
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.smartphone_userlist.value.productReview == null ||
        productviewcontroller.smartphone_userlist.value.productReview!
    ...
    return Container(
      height: Get.height * .5,
      child: ListView.builder(
        itemCount: productviewcontroller.smartphone_userlist.value.productReview
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "${productviewcontroller.smartphone_userlist.value.productReview?.productAverageReview?.toString()}",
                    ...
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.smartphone_userlist
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.smartphone_userlist.value.productReview?.productReviewDetails?[index].userImage.toString()}",
                        height: 60.adaptSize,
                        width: 60.adaptSize,
                        radius: BorderRadius.circular(
                          30.h,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.smartphone_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'League Spartan',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.smartphone_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'League Spartan',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                padding: EdgeInsets.only(left: 20.h),
                child: CustomRatingBar(
                  initialRating: productviewcontroller.smartphone_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.smartphone_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'League Spartan',
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemCount: productviewcontroller.smartphone_userlist.value
                  ...
                  itemBuilder: (context, index) {
                    return SizedBox(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.smartphone_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
                        height: 80.adaptSize,
                        width: 80.adaptSize,
                        radius: BorderRadius.circular(
                          8.h,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.smartphone_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var color = productviewcontroller.smartphone_userlist.value
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.smartphone_userlist.value
              .productView?.productDetails?.details?[index].Model;
                              ...
                              CustomImageView(
                                ...
                                onTap: () {
                                  engallmainCatId = _allProduct_controller
                                      ...
                                      .mainCategoryId!
                                      .toString();
                                  String? allProductId = _allProduct_controller
                                      .userList.value.allProductList?[index].id!
                                      .toString();

                                  setState(() {
                                    Englishproductid = allProductId;
                                    EnglishMainCatId = engallmainCatId;
                                  });
                                  ...
                                  if (engallmainCatId == "153") {
                                    ...
                                    Get.to(AllSinglePageScreen_Mens_Formals());
