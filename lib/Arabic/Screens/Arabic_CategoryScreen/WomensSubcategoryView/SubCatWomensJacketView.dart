...
class arabicSubCat_Womens_Jacket extends StatefulWidget {
  const arabicSubCat_Womens_Jacket({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Womens_Jacket> createState() =>
      _arabicSubCat_Womens_JacketState();
}

class _arabicSubCat_Womens_JacketState
    extends State<arabicSubCat_Womens_Jacket> {
  ...
  Widget _buildAddtocartWomens_JacketView(
