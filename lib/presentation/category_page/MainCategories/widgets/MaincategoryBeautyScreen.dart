...
class MaincategoryBeautyScreen extends StatefulWidget {
  const MaincategoryBeautyScreen({Key? key}) : super(key: key);

  @override
  State<MaincategoryBeautyScreen> createState() =>
      _MaincategoryBeautyScreenState();
}

class _MaincategoryBeautyScreenState extends State<MaincategoryBeautyScreen> {
  @override
  void initState() {
    ...
    return Scaffold(
      body: Obx(() {
        if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
          ...
          return _categoryByName.beauty_userlist.value.seeAllMainCategory ==
                      null ||
                  _categoryByName
                          .beauty_userlist.value.seeAllMainCategory?.length ==
                      0
              ? Center(
                  child: Padding(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: GridView.builder(
                              ...
                              itemCount: _categoryByName.beauty_userlist.value
                                    ...
                                    children: [
                                      AnimatedContainer(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            "${_categoryByName.beauty_userlist.value.seeAllMainCategory?[index].imageUrl.toString()}",
                                            height: 68,
                                            width: 68,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      Center(
                                        child: Text(
                                          "${_categoryByName.beauty_userlist.value.seeAllMainCategory?[index].categoryName.toString()}",
                                          style: TextStyle(
