    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: Get.height*.01,),
         Text( "Office address",  style: CustomTextStyles.titleLargeBold,  ),
          SizedBox(height: Get.height*.01,),
         Text( " 3 Newbridge Court " , style: CustomTextStyles.bodyLargeGray50001_3,  ),
         Text( "Chino Hills,CA 91709, United States" , style: CustomTextStyles.bodyLargeGray50001_3,),
        ...
        SizedBox(height: Get.height*.01,),
         Text( "Email Us",  style: CustomTextStyles.titleLargeBold,  ),
          SizedBox(height: Get.height*.01,),
        ...
        SizedBox(height: Get.height*.01,),
         Text( "Need help?",  style: CustomTextStyles.titleLargeBold,  ),
          SizedBox(height: Get.height*.01,),
         Text( " You can contact Mohally" , style: CustomTextStyles.bodyLargeGray50001_3,  ),
         Text( "customer service for help." , style: CustomTextStyles.bodyLargeGray50001_3,),
         SizedBox(height: Get.height*.01,),
         Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text( "Need help",  style: theme.textTheme.bodyMedium?.copyWith(color: Color(0xffff8300)),  ),
