...
class arabic_SubCat_Electronics_camera extends StatefulWidget {
  const arabic_SubCat_Electronics_camera({Key? key}) : super(key: key);

  @override
  State<arabic_SubCat_Electronics_camera> createState() =>
      _arabic_SubCat_Electronics_cameraState();
}

class _arabic_SubCat_Electronics_cameraState
    extends State<arabic_SubCat_Electronics_camera> {
        ...
        child: Obx(() {
          if (_productbycatid_controller.rxRequestStatus.value ==
            ...
            return _productbycatid_controller
                            .camera_userlist.value.productByCategory ==
                        null ||
                    _productbycatid_controller
                            .camera_userlist.value.productByCategory?.length ==
                        0
                ? Center(
                    child: Column(
                    children: [
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: _productbycatid_controller.camera_userlist
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_productbycatid_controller.camera_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                                            _productbycatid_controller
                                                .camera_userlist
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.camera_userlist.value.productByCategory?[index].aTitle.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_productbycatid_controller.camera_userlist.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_productbycatid_controller.camera_userlist.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
