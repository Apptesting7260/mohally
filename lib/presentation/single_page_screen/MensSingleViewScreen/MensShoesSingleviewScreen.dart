...
class _SinglePageScreen_Mens_ShoesState extends State<SinglePageScreen_Mens_Shoes> {
              ...
              child: productviewcontroller
                  ...
                  : ListView(
                      ...
                      children: [
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text:
                                                    '${productviewcontroller.mensshoes_userlist.value.productView!.price}',
                        ...
                        // //         .mensshoes_userlist.value.productReview !=
                        // //     null)
                  ...
                  if (color != null && size1 != null) {
                    if (colorId == null) {
                      ...
                      EnglishAddtocartprice = productviewcontroller
                          .mensshoes_userlist.value.productView?.price
                          .toString();
