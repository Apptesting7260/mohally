...
class SubCat_Health_personalProductScreen extends StatefulWidget {
  final bool showAppBar;
  const SubCat_Health_personalProductScreen({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<SubCat_Health_personalProductScreen> createState() =>
      _SubCat_Health_personalProductScreenState();
}

class _SubCat_Health_personalProductScreenState
    extends State<SubCat_Health_personalProductScreen> {
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                          .healthwellness_personal.value.productByCategory ==
                      null ||
                  _productbycatid_controller.healthwellness_personal.value
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.healthwellness_personal.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.healthwellness_personal.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.healthwellness_personal.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.healthwellness_personal.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
