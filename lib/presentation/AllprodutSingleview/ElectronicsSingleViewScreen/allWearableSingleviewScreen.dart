...
class ALLSinglePageScreen_Electronics_wearable extends StatefulWidget {
  const ALLSinglePageScreen_Electronics_wearable({Key? key})
      : super(
          key: key,
        );

  @override
  State<ALLSinglePageScreen_Electronics_wearable> createState() =>
      _ALLSinglePageScreen_Electronics_wearableState();
}

class _ALLSinglePageScreen_Electronics_wearableState
    extends State<ALLSinglePageScreen_Electronics_wearable> {
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.wearable_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
          ...
          return CustomOutlinedButton(
            ...
            onPressed: () {
              Englishcartproductid = productviewcontroller
                  ...
                  .toString();
              EnglishAddtocartColor = productviewcontroller.wearable_userlist
                  .value.productView?.productDetails?.details?[0].ColorId
                  .toString();
              EnglishAddtocartprice = productviewcontroller.wearable_userlist
                  .value.productView?.productDetails?.details?[index].price
                  .toString();
              EnglishAddtocartSize = productviewcontroller.wearable_userlist
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemCount: productviewcontroller.wearable_userlist.value.productView
              ...
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.wearable_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var color = productviewcontroller.wearable_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.wearable_userlist.value.productView
