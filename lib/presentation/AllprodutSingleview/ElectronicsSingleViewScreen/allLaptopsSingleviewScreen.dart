...
class ALLSinglePageScreen_Electronics_Laptops extends StatefulWidget {
  const ALLSinglePageScreen_Electronics_Laptops({Key? key})
      : super(
          key: key,
        );

  @override
  State<ALLSinglePageScreen_Electronics_Laptops> createState() =>
      _ALLSinglePageScreen_Electronics_LaptopsState();
}

class _ALLSinglePageScreen_Electronics_LaptopsState
    extends State<ALLSinglePageScreen_Electronics_Laptops> {
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.laptops_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
          ...
          return CustomOutlinedButton(
            ...
            onPressed: () {
              Englishcartproductid = productviewcontroller
                  ...
                  .toString();
              EnglishAddtocartColor = productviewcontroller.laptops_userlist
                  .value.productView?.productDetails?.details?[0].ColorId
                  .toString();
              EnglishAddtocartprice = productviewcontroller.laptops_userlist
                  .value.productView?.productDetails?.details?[index].price
                  .toString();
              EnglishAddtocartSize = productviewcontroller.laptops_userlist
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemCount: productviewcontroller.laptops_userlist.value.productView
              ...
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.laptops_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.laptops_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var color = productviewcontroller.laptops_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.laptops_userlist.value.productView
