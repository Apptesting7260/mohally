...
class MaincategoryKitchenScreen extends StatefulWidget {
  ...
  @override
  State<MaincategoryKitchenScreen> createState() =>
      _MaincategoryKitchenScreenState();
}

class _MaincategoryKitchenScreenState extends State<MaincategoryKitchenScreen> {
  @override
  void initState() {
    ...
    return Scaffold(
      body: Obx(() {
        if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
          ...
          return _categoryByName.kitchen_userlist.value.seeAllMainCategory ==
                      null ||
                  _categoryByName
                          .kitchen_userlist.value.seeAllMainCategory?.length ==
                      0
              ? Center(
                  child: Padding(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: GridView.builder(
                              ...
                              itemCount: _categoryByName.kitchen_userlist.value
                                    ...
                                    children: [
                                      AnimatedContainer(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            "${_categoryByName.kitchen_userlist.value.seeAllMainCategory?[index].imageUrl.toString()}",
                                            height: 68,
                                            width: 68,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      Center(
                                        child: Text(
                                          "${_categoryByName.kitchen_userlist.value.seeAllMainCategory?[index].categoryName.toString()}",
                                          style: TextStyle(
