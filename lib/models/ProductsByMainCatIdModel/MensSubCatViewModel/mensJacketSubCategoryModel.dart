class MensJacketSubCategoryByCategoryIdModel {
  MensJacketSubCategoryByCategoryIdModel({
    this.status,
  ...
  MensJacketSubCategoryByCategoryIdModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
