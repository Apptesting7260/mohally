class ArabicJacketandOutwearModel {
  ArabicJacketandOutwearModel({
    this.status,
    this.modalCategory,
    this.productView,
    this.productReview,
  ...
  ArabicJacketandOutwearModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Details {
  ...
  late final Null Size;
  late final Null SizeId;
  late final Null Color;
  late final Null ColorId;
  var totalQuantity;
  late final Null totalQuantityId;
  var price;
  late final Null priceId;
  late final Null sku;
  late final Null skuId;
  var productPrice;
  late final Null productPriceId;
