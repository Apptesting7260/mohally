...
class SubCat_Electronics_laptops extends StatefulWidget {
  final bool showAppBar;

  const SubCat_Electronics_laptops({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<SubCat_Electronics_laptops> createState() =>
      _SubCat_Electronics_laptopsState();
}

class _SubCat_Electronics_laptopsState
    extends State<SubCat_Electronics_laptops> {
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.laptops_userlist.value.productByCategory?[index].title.toString()}",
