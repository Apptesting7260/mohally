...
class AllSinglePageScreen_mens_Jacket extends StatefulWidget {
  const AllSinglePageScreen_mens_Jacket({Key? key})
      : super(
          key: key,
        );

  @override
  State<AllSinglePageScreen_mens_Jacket> createState() =>
      _AllSinglePageScreen_mens_JacketState();
}

class _AllSinglePageScreen_mens_JacketState
    extends State<AllSinglePageScreen_mens_Jacket> {
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemCount: productviewcontroller.jacket_userlist.value.productView
              ...
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.jacket_userlist.value
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.jacket_userlist.value.productView
