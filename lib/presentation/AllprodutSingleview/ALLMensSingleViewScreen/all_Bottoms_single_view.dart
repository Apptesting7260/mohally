...
class AllSinglePageScreen_Bottoms extends StatefulWidget {
  const AllSinglePageScreen_Bottoms({Key? key})
      : super(
          key: key,
        );

  @override
  State<AllSinglePageScreen_Bottoms> createState() =>
      _AllSinglePageScreen_BottomsState();
}

class _AllSinglePageScreen_BottomsState
    extends State<AllSinglePageScreen_Bottoms> {
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.Bottom_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemCount: productviewcontroller.Bottom_userlist.value.productView
              ...
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.Bottom_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.Bottom_userlist.value.productView
