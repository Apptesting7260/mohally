...
class SubCat_Mens_jacket extends StatefulWidget {
  final bool showAppBar;
  const SubCat_Mens_jacket({Key? key, this.showAppBar = true})
      : super(key: key);

  @override
  State<SubCat_Mens_jacket> createState() => _SubCat_Mens_jacketState();
}

class _SubCat_Mens_jacketState extends State<SubCat_Mens_jacket> {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.jacket_userlist.value.productByCategory?[index].title.toString()}",
