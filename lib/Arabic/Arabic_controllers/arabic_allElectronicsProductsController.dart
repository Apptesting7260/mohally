...
class ArabicElectronicsAllProductController extends GetxController {
  final _api = AuthRepository();

  final rxRequestStatus = Status.LOADING.obs;
  final electronics = ArabicMensAllProductModel().obs;
  RxString error = ''.obs;

  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setUserList(ArabicMensAllProductModel value) =>
  ...
  void ElectronicsAllProductView() async {
    ...
    loading.value = true;
    Map data = {"cat_id": "175", "language_type": "Arabic"};
