...
class arabicSubCat_Mens_formals extends StatefulWidget {
  const arabicSubCat_Mens_formals({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Mens_formals> createState() =>
      _arabicSubCat_Mens_formalsState();
}

class _arabicSubCat_Mens_formalsState extends State<arabicSubCat_Mens_formals> {
            ...
            return _productbycatid_controller
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: _productbycatid_controller.formal_userlist
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.formal_userlist.value.productByCategory?[index].aTitle.toString()}",
