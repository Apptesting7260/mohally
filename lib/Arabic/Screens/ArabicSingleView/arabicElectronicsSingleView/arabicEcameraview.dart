...
class ArabicElectronicsCameraSingleShViewScreen extends StatefulWidget {
  const ArabicElectronicsCameraSingleShViewScreen({Key? key})
      : super(
          key: key,
        );

  @override
  State<ArabicElectronicsCameraSingleShViewScreen> createState() =>
      _ArabicElectronicsCameraSingleShViewScreenState();
}

class _ArabicElectronicsCameraSingleShViewScreenState
    extends State<ArabicElectronicsCameraSingleShViewScreen> {
