...
class ArabicWomensTopSingleShViewScreen extends StatefulWidget {
  const ArabicWomensTopSingleShViewScreen({Key? key})
      : super(
          key: key,
        );

  @override
  State<ArabicWomensTopSingleShViewScreen> createState() =>
      _ArabicWomensTopSingleShViewScreenState();
}

class _ArabicWomensTopSingleShViewScreenState
    extends State<ArabicWomensTopSingleShViewScreen> {
        ...
        return SafeArea(
          child: Scaffold(
            body: Directionality(
              ...
              child: productviewcontroller.womens_topView.value.productView ==
                      null
                  ...
                  : SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          // Text(
                          //                       "${productviewcontroller.womens_topView.value.productView?.productDetails.toString()}",
                          //                     // "سترة NOBERO للرجال من القطن للسفر بتصميم سادة وغطاء للرأس رياضي شتوي",
                          //                     maxLines: 2,
                          //                     overflow: TextOverflow.ellipsis,
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      '${productviewcontroller.womens_topView.value.productView!.productDetails!.details?[index].price.toString()}',
                                                ...
                                                TextSpan(
                                                  text:
                                                      "${productviewcontroller.womens_topView.value.productView!.productDetails!.details?[index].productPrice.toString()}",
                                                  style: CustomTextStyles
                          ...
                          SizedBox(height: 14.v),
                          // Obx(() {
                          // var materialTags = productviewcontroller.womens_topView
                          //     .value.productView?.productCatgories?.tags;
                          // var materialsubTags = productviewcontroller.womens_topView
      ...
      child: Stack(
        ...
        children: [
          ListView.builder(
            ...
            itemCount: productviewcontroller
                    .womens_topView.value.productView?.galleryUrl?.length ??
                0,
            itemBuilder: (BuildContext context, int index) {
          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                ...
                //     context,
                //     selectedImageIndex,
                //     productviewcontroller.womens_topView.value
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller
                    .womens_topView.value.productView?.galleryUrl?[index] ??
                '';
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size = productviewcontroller.womens_topView.value.productView
              ?.productDetails?.details?[index].Size
              .toString();
          if (size == null) {
            return Text('');
          }
      ...
      child: Align(
        ...
        child: SizedBox(
          ...
          child: ListView.separated(
            ...
            itemCount: productviewcontroller.womens_topView.value.productView
                    ?.productDetails?.details!.length ??
                0,
            itemBuilder: (context, index) {
              if (index < 0 ||
                  index >=
                      (productviewcontroller.womens_topView.value.productView!
                              .productDetails?.details!.length ??
                          0)) {
                ...
                child: GestureDetector(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          '${productviewcontroller.womens_topView.value.productView?.productDetails?.details?[index].Size.toString()}',
                          style: TextStyle(
  ...
  /// Section Widget
//   Widget _buildListWidget(BuildContext context) {
// //List<ProductDetails>? productDetails = productviewcontroller.womens_topView.value.productView?.productDetails;
...
//             },
//             itemCount: productviewcontroller
//                     .womens_topView.value.productView?.productDetails?.length ??
//                 0,
//             itemBuilder: (context, index) {
//               if (index < 0 ||
//                   index >=
...
//               String sizeCapacity = productviewcontroller.womens_topView.value
...
//   }
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.womens_topView.value.productReview == null ||
        productviewcontroller
                .womens_topView.value.productReview!.productReviewDetails ==
            null ||
        productviewcontroller.womens_topView.value.productReview!
    ...
    return Container(
      ...
      child: ListView.builder(
        physics: NeverScrollableScrollPhysics(),
        itemCount: productviewcontroller.womens_topView.value.productReview
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.womens_topView
                    ...
                    Text(
                      "${productviewcontroller.womens_topView.value.productReview?.productAverageReview?.toString()}",
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.womens_topView.value.productReview?.productReviewDetails?[index].userImage.toString()}",
                        height: 60.adaptSize,
                        width: 60.adaptSize,
                        radius: BorderRadius.circular(
                          30.h,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.womens_topView.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'Almarai',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.womens_topView.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'Almarai',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                ...
                child: CustomRatingBar(
                  initialRating: productviewcontroller.womens_topView.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.womens_topView.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'Almarai',
              ...
              SizedBox(height: 13.v),
              // Obx(() {
              //   if (productviewcontroller.womens_topView.value
              ...
              //     return CustomImageView(
              //       imagePath:
              //           "${productviewcontroller.womens_topView.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
              //       height: 80.adaptSize,
              //       width: 80.adaptSize,
              //       radius: BorderRadius.circular(
              //         8.h,
              ...
              //       );
              //     },
              //     itemCount: productviewcontroller.womens_topView.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "مفيد(${productviewcontroller.womens_topView.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'Almarai',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          color = productviewcontroller.womens_topView.value.productView
  ...
  Widget _buildSize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.womens_topView.value.productView
              ?.productDetails?.details?[index].Size;
                ...
                if (color != null && size1 != null) {
                  if (colorId == null) {
                    ...
                    Arabiccartproductid = productviewcontroller
                        .womens_topView.value.productView?.id
                        .toString();
                  ...
                  Arabiccartproductid = productviewcontroller
                      ...
                      .toString();
                  ArabicAddtocartColor = colorId.toString();
                  ArabicAddtocartprice = productviewcontroller.womens_topView
