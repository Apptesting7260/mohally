...
import 'package:mohally/view_models/controller/ReviewHelpfulController/reviewHelpfulController.dart';
...
class Womens_Dress_SingleView extends StatefulWidget {
  const Womens_Dress_SingleView({Key? key})
      : super(
          key: key,
        );

  @override
  State<Womens_Dress_SingleView> createState() =>
      _Womens_Dress_SingleViewState();
}

class _Womens_Dress_SingleViewState extends State<Womens_Dress_SingleView> {
  ProductReviewHelpful _reviewcontroller = ProductReviewHelpful();
          ...
          body: SafeArea(
            child: Container(
              ...
              child: productviewcontroller
                          .womensDress_userlist.value.productView ==
                      null
                  // productviewcontroller.womensDress_userlist.value
                  //         .productView?.length ==
                  //     0
                  ? Center(
                      child: Padding(
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.womensDress_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                ...
                                child: Row(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        "${productviewcontroller.womensDress_userlist.value.productReview?.productAverageReview.toString()}",
                                        // "4.8",
 ...
 Widget _buildButtonOneHundredTen(
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemCount: productviewcontroller
                  .womensDress_userlist.value.productView?.galleryUrl?.length ??
              0,
          itemBuilder: (context, index) {
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            GestureDetector(
              onTap: () {
                reviewProductid = productviewcontroller
                    .womensDress_userlist.value.productView?.id
                    .toString();

                // setState(() {
                //   viewReviewProductId = reviewProductid;
                // });
                print(reviewProductid);
                Get.to(() => ReviewsScreen(), arguments: reviewProductid);

                _viewreviewcontroller.reviewViewapiHit(
                    context, reviewProductid.toString());
              },
              child: Text("Show all",
                  style: TextStyle(
                      fontSize: 14,
      ...
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          String imageUrl = productviewcontroller
                  .womensDress_userlist.value.productView?.galleryUrl?[index] ??
              '';
          return SizedBox(
            height: Get.height * .1,
            //  width: 80.adaptSize,
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.womensDress_userlist.value.productReview ==
            null ||
        productviewcontroller.womensDress_userlist.value.productReview!
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: productviewcontroller.womensDress_userlist.value
            ...
            0,
        itemBuilder: (BuildContext context, int index) {
          String helpfulStatus = productviewcontroller
                  .womensDress_userlist
                  .value
                  .productReview
...
// Set likeIsActive based on helpful_status
          bool likeIsActive = helpfulStatus == "Active";
          String imageUrl = productviewcontroller.womensDress_userlist.value
          ...
          return Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.womensDress_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'League Spartan',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.womensDress_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'League Spartan',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.womensDress_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'League Spartan',
                  ...
                  itemBuilder: (context, index) {
                    if (productviewcontroller
                      ...
                      return SizedBox(
                        ...
                        child: CustomImageView(
                          imagePath:
                              "${productviewcontroller.womensDress_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
                          height: 80.adaptSize,
                          width: 80.adaptSize,
                          radius: BorderRadius.circular(
                            8.h,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        productreviewProductId = productviewcontroller
                            .womensDress_userlist.value.productView!.id
                            .toString();

                        productreviewId = productviewcontroller
                            .womensDress_userlist
                            .value
                            .productReview
                            ?.productReviewDetails?[index]
                        ...
                        _reviewcontroller.producthelpful_Apihit(context);
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          if (color == null) {
            return SizedBox
                .shrink(); // Return an empty SizedBox to remove extra spacing
          } else {
            return Column(
              children: [
                Padding(
                            ...
                            TextSpan(
                              text: Aselectedcolored.value.isNotEmpty
                                  ...
                                  : productviewcontroller
                                      ...
                                      .Color,
                              style: theme.textTheme.titleMedium?.copyWith(
                                  fontSize: 18, color: Color(0xffff8300)),
                            ),
                          ],
                        ),
                        textAlign: TextAlign.left,
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.womensDress_userlist.value.productView
