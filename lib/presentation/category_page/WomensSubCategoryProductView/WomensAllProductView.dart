...
import 'package:mohally/view_models/controller/WomensAllProductController/womensAllProductController.dart';
...
class WomensAllProduct extends StatefulWidget {
  const WomensAllProduct({Key? key}) : super(key: key);

  @override
  State<WomensAllProduct> createState() => _WomensAllProductState();
}

class _WomensAllProductState extends State<WomensAllProduct> {
  ...
  void initState() {
    ...
    super.initState();
    _productbycatid_controller.WomensAllProductView();
  }

  List<bool> isButtonTappedList = List.generate(200, (index) => false);
  WomensAllProductEnglish _productbycatid_controller =
      WomensAllProductEnglish();
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller.Womens.value.productByCategory ==
                      null ||
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.Womens.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.Womens.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.Womens.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.Womens.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
