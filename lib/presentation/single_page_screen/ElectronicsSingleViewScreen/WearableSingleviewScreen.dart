...
class SinglePageScreen_Electronics_wearable extends StatefulWidget {
  const SinglePageScreen_Electronics_wearable({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Electronics_wearable> createState() =>
      _SinglePageScreen_Electronics_wearableState();
}

class _SinglePageScreen_Electronics_wearableState
    extends State<SinglePageScreen_Electronics_wearable> {
