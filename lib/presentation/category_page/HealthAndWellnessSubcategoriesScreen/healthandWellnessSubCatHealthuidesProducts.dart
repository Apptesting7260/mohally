...
class SubCat_Health_healthGuideProductScreen extends StatefulWidget {
  final bool showAppBar;
  const SubCat_Health_healthGuideProductScreen(
      {Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<SubCat_Health_healthGuideProductScreen> createState() =>
      _SubCat_Health_healthGuideProductScreenState();
}

class _SubCat_Health_healthGuideProductScreenState
    extends State<SubCat_Health_healthGuideProductScreen> {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller.healthwellness_healthGuides.value
                          .productByCategory ==
                      null ||
                  _productbycatid_controller.healthwellness_healthGuides.value
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.healthwellness_healthGuides.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.healthwellness_healthGuides.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.healthwellness_healthGuides.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.healthwellness_healthGuides.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
