    ...
    return null;
      ...
      if (phoneNumber.isEmpty) {
        ...
        Utils.snackBar(context, 'Failed', 'Please enter mobile number');
          ...
          Utils.snackBar(context, 'Failed', 'Please enter a valid Mobile Number');
        } 
          if (signup_controller.phoneController.value.text.isNotEmpty &&
              signup_controller.phoneController.value.text.length == 10) {

            userVerify_controller.UserVerify_apihit( signup_controller.phoneController.value.text.toString()
            );
                                  showDialog(
                                    context: context,
                                    builder: (context) {
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          GestureDetector(
                              onTap: () {
                                verifyemailOTP_controller.pinController
                                    .value
                                    .clear();
                                Future.delayed(Duration(seconds: 1), () {
                          ...
                          CustomElevatedButton(
                            onPressed: () {
                              ...
                              if (verifyemailOTP_controller.pinController
                                  .value.text.isEmpty) {
                               Utils.snackBar(context ,'Failed', 'Please enter the OTP');
                              } else {
                                if (verifyemail_controller.userList.value.otp
                                        .toString() ==
                                    verifyemailOTP_controller.pinController
                                        .value.text) {
                                  ...
                                  Utils.snackBar(
                                      context,'Failed', 'Please Enter Correct Otp');
                                  print('Incorrect OTP');
                                }
                              }
                            },
