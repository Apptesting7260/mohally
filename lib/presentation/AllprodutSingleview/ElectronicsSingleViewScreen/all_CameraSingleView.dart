...
class ALLSinglePageScreen_Electronics_Camera extends StatefulWidget {
  const ALLSinglePageScreen_Electronics_Camera({Key? key})
      : super(
          key: key,
        );

  @override
  State<ALLSinglePageScreen_Electronics_Camera> createState() =>
      _ALLSinglePageScreen_Electronics_CameraState();
}

class _ALLSinglePageScreen_Electronics_CameraState
    extends State<ALLSinglePageScreen_Electronics_Camera> {
        ...
        return SafeArea(
          child: Scaffold(
            body: Container(
              width: Get.width,
              height: Get.height,
              child: productviewcontroller.camera_userlist.value.productView ==
                      null
                  ? Center(
                      child: Padding(
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.camera_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                        ...
                        SizedBox(height: 14.v),
                        // Obx(() {
                        // var materialTags = productviewcontroller.camera_userlist
                        //     .value.productView?.productCatgories?.tags;
                        // var materialsubTags = productviewcontroller.camera_userlist
            ...
            child: Column(
              ...
              children: [
                ...
                _buildButtonOneHundredTen(
                    context,
                    selectedImageIndex,
                    productviewcontroller.camera_userlist.value.productView
                            ?.galleryUrl?.length ??
                        0),
                SizedBox(height: 10.v),
                Padding(
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemCount: productviewcontroller
                  .camera_userlist.value.productView?.galleryUrl?.length ??
              0,
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller
                    .camera_userlist.value.productView?.galleryUrl?[index] ??
                '';
          ...
          return CustomOutlinedButton(
            ...
            onPressed: () {
              Englishcartproductid = productviewcontroller
                  ...
                  .toString();
              EnglishAddtocartColor = productviewcontroller.camera_userlist
                  .value.productView?.productDetails?.details?[0].ColorId
                  .toString();
              EnglishAddtocartprice = productviewcontroller.camera_userlist
                  .value.productView?.productDetails?.details?[index].price
                  .toString();
              EnglishAddtocartSize = productviewcontroller.camera_userlist.value
                  .productView?.productDetails?.details?[0].Model
                  .toString();
  ...
  Widget _buildcontentofimg1(BuildContext context) {
    return Column(
      children: [
        ...
        ListView.builder(
          shrinkWrap: true,
          itemCount: productviewcontroller.camera_userlist.value.productView
                  ?.productCatgories?.tags?.item?.length ??
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.camera_userlist.value
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.camera_userlist.value.productReview == null ||
        productviewcontroller
                .camera_userlist.value.productReview!.productReviewDetails ==
            null ||
        productviewcontroller.camera_userlist.value.productReview!
    ...
    return Container(
      height: Get.height * .5,
      child: ListView.builder(
        itemCount: productviewcontroller.camera_userlist.value.productReview
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "${productviewcontroller.camera_userlist.value.productReview?.productAverageReview?.toString()}",
                    ...
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.camera_userlist
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.camera_userlist.value.productReview?.productReviewDetails?[index].userImage.toString()}",
                        height: 60.adaptSize,
                        width: 60.adaptSize,
                        radius: BorderRadius.circular(
                          30.h,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.camera_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'League Spartan',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.camera_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'League Spartan',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                padding: EdgeInsets.only(left: 20.h),
                child: CustomRatingBar(
                  initialRating: productviewcontroller.camera_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.camera_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'League Spartan',
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemCount: productviewcontroller.camera_userlist.value
                  ...
                  itemBuilder: (context, index) {
                    return SizedBox(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.camera_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
                        height: 80.adaptSize,
                        width: 80.adaptSize,
                        radius: BorderRadius.circular(
                          8.h,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.camera_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var color = productviewcontroller.camera_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.camera_userlist.value.productView
