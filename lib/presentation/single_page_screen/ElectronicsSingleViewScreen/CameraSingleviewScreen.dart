...
class SinglePageScreen_Electronics_Camera extends StatefulWidget {
  const SinglePageScreen_Electronics_Camera({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Electronics_Camera> createState() =>
      _SinglePageScreen_Electronics_CameraState();
}

class _SinglePageScreen_Electronics_CameraState
    extends State<SinglePageScreen_Electronics_Camera> {
