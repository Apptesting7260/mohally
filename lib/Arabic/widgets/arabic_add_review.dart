...
class AddReviewScreen_arabic extends StatelessWidget {
  ...
  Widget _buildNameEditText(BuildContext context) {
    return CustomTextFormField(
      ...
      hintText:  'أدخل أسمك',
      hintStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w300, fontFamily: 'Almarai',),
  ...
  Widget _buildAddPhotosVideoButton(BuildContext context) {
    return CustomOutlinedButton(
      ...
      buttonTextStyle: TextStyle(fontSize: 18,fontWeight: FontWeight.w400, color: Color(0XFF8F959E), fontFamily: 'Almarai' ),
  ...
  Widget _buildSubmitReviewButton(BuildContext context) {
    return CustomElevatedButton(
     ...
     buttonTextStyle: TextStyle(fontSize: 18,fontWeight: FontWeight.w400, color: Colors.white, fontFamily: 'Almarai' ),
      alignment: Alignment.center,
    );
  }
          ...
          children: [
           GestureDetector(
            onTap: (){
             ...
             child: Container(
                       ...
                       width: Get.width*.07,
                       decoration: BoxDecoration(shape: BoxShape.circle,color:  Color(0xffff8300),),
                       child: Center(
                    ...
                    children: [
                     Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                                 ...
                                 Text('تصوير', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, fontFamily: 'Almarai', color:Colors.black),)
                                 ],
                     ),
           ...
           Row(
            ...
            Image.asset('assets/images/blackvideo.png'),
              SizedBox(width: Get.width*.01,),
            Text('اختر من الألبوم', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, fontFamily: 'Almarai', color:Colors.black),)
            ],
                     ),
                         SizedBox(height: Get.height*.01,),
            Text('يلغي', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, fontFamily: 'Almarai', color: Color(0xffff8300)),)
                    ],
           )
          ],
        ),
