...
class arabicSubCat_Mens_Bottoms extends StatefulWidget {
  const arabicSubCat_Mens_Bottoms({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Mens_Bottoms> createState() =>
      _arabicSubCat_Mens_BottomsState();
}

class _arabicSubCat_Mens_BottomsState extends State<arabicSubCat_Mens_Bottoms> {
        ...
        child: Obx(() {
          if (_productbycatid_controller.rxRequestStatus.value ==
            ...
            return _productbycatid_controller
                            .Bottom_userlist.value.productByCategory ==
                        null ||
                    _productbycatid_controller
                            .Bottom_userlist.value.productByCategory?.length ==
                        0
                ? Center(
                    child: Column(
                    children: [
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: _productbycatid_controller.Bottom_userlist
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_productbycatid_controller.Bottom_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                                            _productbycatid_controller
                                                .Bottom_userlist
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.Bottom_userlist.value.productByCategory?[index].aTitle.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_productbycatid_controller.Bottom_userlist.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_productbycatid_controller.Bottom_userlist.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
