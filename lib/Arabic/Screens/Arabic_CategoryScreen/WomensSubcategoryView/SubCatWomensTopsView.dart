...
class arabicSubCat_Womens_Tops extends StatefulWidget {
  const arabicSubCat_Womens_Tops({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Womens_Tops> createState() =>
      _arabicSubCat_Womens_TopsState();
}

class _arabicSubCat_Womens_TopsState extends State<arabicSubCat_Womens_Tops> {
        ...
        child: Obx(() {
          if (_productbycatid_controller.rxRequestStatus.value ==
            ...
            return _productbycatid_controller
                            .womens_topUserlist.value.productByCategory ==
                        null ||
                    _productbycatid_controller.womens_topUserlist.value
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: _productbycatid_controller.womens_topUserlist
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_productbycatid_controller.womens_topUserlist.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.womens_topUserlist.value.productByCategory?[index].aTitle.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_productbycatid_controller.womens_topUserlist.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_productbycatid_controller.womens_topUserlist.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
                                        ...
                                        Timer(Duration(seconds: 2), () {
                                          if (productviewcontroller
                                            ...
                                            showModalBottomSheet(
                                                ...
                                                builder: (context) {
                                                  return _buildAddtocartWomens_topView(
                                                      context,
                                                      arabicMainCatId,
                                                      arproductId);
                                                });
  ...
  Widget _buildAddtocartWomens_topView(
