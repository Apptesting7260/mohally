...
class OrderConfirmedScreen_arabic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar:  AppBar(
          title: Text('تم تاكيد الطلب', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'Almarai', ),),
          leading: Padding(
                ...
                child: Stack(
                  ...
                  children: [
                    Align(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                style:TextStyle(fontFamily: 'Almarai',fontSize: 16, fontWeight: FontWeight.w600, color: Colors.grey,)
                              ),
                            ),
                            ...
                            CustomElevatedButton(
                              ...
                              buttonStyle: CustomButtonStyles.fillPrimary,
                                      buttonTextStyle: theme.textTheme.titleMedium?.copyWith(fontFamily: 'Almarai',color: Colors.white)
                            ),
                            SizedBox(height: Get.height*.05,),
                      ...
                      buttonTextStyle: theme.textTheme.titleMedium?.copyWith(fontFamily: 'Almarai'),
                      alignment: Alignment.bottomCenter,
                    ),
                          ],
                        ),
