...
class GroceryAllProducts extends StatefulWidget {
  final bool showAppBar;
  const GroceryAllProducts({Key? key, this.showAppBar: true}) : super(key: key);

  @override
  State<GroceryAllProducts> createState() => _GroceryAllProductsState();
}

class _GroceryAllProductsState extends State<GroceryAllProducts> {
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                      .Grocery_userlist.value.productByCategory ==
                  null
              ? NoProductFound(
                  showAppBar: false,
                )
                    ...
                    children: [
                      Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: _productbycatid_controller.Grocery_userlist
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.Grocery_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.Grocery_userlist.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.Grocery_userlist.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.Grocery_userlist.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
