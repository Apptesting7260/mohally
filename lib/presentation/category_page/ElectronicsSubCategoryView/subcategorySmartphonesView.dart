...
class SubCat_Electronics_smartphone extends StatefulWidget {
  const SubCat_Electronics_smartphone({Key? key}) : super(key: key);

  @override
  State<SubCat_Electronics_smartphone> createState() =>
      _SubCat_Electronics_smartphoneState();
}

class _SubCat_Electronics_smartphoneState
    extends State<SubCat_Electronics_smartphone> {
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.smartphone_userlist.value.productByCategory?[index].title.toString()}",
                                          ...
                                          onTap: () {
                                            ...
                                            if (mainCatId == "166") {
                                              ...
                                              showModalBottomSheet(
                                                  ...
                                                  builder: (context) {
                                                    return _buildAddtocartElectronicsSmartPhone(
                                                        context,
                                                        mainCatId,
                                                        productId);
                                                  });
  ...
  Widget _buildAddtocartElectronicsSmartPhone(
