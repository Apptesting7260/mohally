...
class _Allelectronics_productviewState
  ...
  void initState() {
    ...
    super.initState();
    _allmensproductcontroller.ElectronicsAllProductView();
  }

  List<bool> isButtonTappedList = List.generate(200, (index) => false);
  ArabicElectronicsAllProductController _allmensproductcontroller =
      ArabicElectronicsAllProductController();
      ...
      body: Directionality(
        ...
        child: Obx(() {
          if (_allmensproductcontroller.rxRequestStatus.value ==
            ...
            return _allmensproductcontroller
                            .electronics.value.productByCategory ==
                        null ||
                    _allmensproductcontroller
                            .electronics.value.productByCategory?.length ==
                        0
                ? Center(
                    child: Column(
                    children: [
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_allmensproductcontroller.electronics.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                                            _allmensproductcontroller
                                                .electronics
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_allmensproductcontroller.electronics.value.productByCategory?[index].title.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_allmensproductcontroller.electronics.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_allmensproductcontroller.electronics.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
