...
class arabicSubCat_Mens_ShirtsView extends StatefulWidget {
  const arabicSubCat_Mens_ShirtsView({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Mens_ShirtsView> createState() =>
      _arabicSubCat_Mens_ShirtsViewState();
}

class _arabicSubCat_Mens_ShirtsViewState
    extends State<arabicSubCat_Mens_ShirtsView> {
