...
import 'package:mohally/view_models/controller/ElectronicsAllProductViewController/electronicsAllProducsView.dart';
...
class ElectronicsAllProduct extends StatefulWidget {
  const ElectronicsAllProduct({Key? key}) : super(key: key);

  @override
  State<ElectronicsAllProduct> createState() => _ElectronicsAllProductState();
}

class _ElectronicsAllProductState extends State<ElectronicsAllProduct> {
  ...
  void initState() {
    ...
    super.initState();
    _productbycatid_controller.ElectronicsAllProductView();
  }
  ...
  ElectronicssAllProductEnglish _productbycatid_controller =
      ElectronicssAllProductEnglish();
                    ...
                    children: [
                      Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: _productbycatid_controller.Electronics
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.Electronics.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.Electronics.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.Electronics.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.Electronics.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
