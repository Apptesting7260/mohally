class HealthandWellnessHealthGuidesProductsviewModel {
  HealthandWellnessHealthGuidesProductsviewModel({
    this.status,
  ...
  HealthandWellnessHealthGuidesProductsviewModel.fromJson(
