...
class arabicSubCat_Womens_Bottom extends StatefulWidget {
  const arabicSubCat_Womens_Bottom({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Womens_Bottom> createState() =>
      _arabicSubCat_Womens_BottomState();
}

class _arabicSubCat_Womens_BottomState
    extends State<arabicSubCat_Womens_Bottom> {
  ...
  Widget _buildAddtocartWomens_BottomsView(
