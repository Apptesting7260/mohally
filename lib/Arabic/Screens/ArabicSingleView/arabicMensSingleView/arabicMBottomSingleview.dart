...
class ArabicMensBottomSingleShViewScreen extends StatefulWidget {
  const ArabicMensBottomSingleShViewScreen({Key? key})
      : super(
          key: key,
        );

  @override
  State<ArabicMensBottomSingleShViewScreen> createState() =>
      _ArabicMensBottomSingleShViewScreenState();
}

class _ArabicMensBottomSingleShViewScreenState
    extends State<ArabicMensBottomSingleShViewScreen> {
        ...
        return SafeArea(
          child: Scaffold(
            body: Directionality(
              ...
              child: productviewcontroller.Bottom_userlist.value.productView ==
                      null
                  ...
                  : SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          // Text(
                          //                       "${productviewcontroller.Bottom_userlist.value.productView?.productDetails.toString()}",
                          //                     // "سترة NOBERO للرجال من القطن للسفر بتصميم سادة وغطاء للرأس رياضي شتوي",
                          //                     maxLines: 2,
                          //                     overflow: TextOverflow.ellipsis,
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      '${productviewcontroller.Bottom_userlist.value.productView!.productDetails!.details?[index].price.toString()}',
                                                ...
                                                TextSpan(
                                                  text:
                                                      "${productviewcontroller.Bottom_userlist.value.productView!.productDetails!.details?[index].productPrice.toString()}",
                                                  style: CustomTextStyles
                          ...
                          SizedBox(height: 14.v),
                          // Obx(() {
                          // var materialTags = productviewcontroller.Bottom_userlist
                          //     .value.productView?.productCatgories?.tags;
                          // var materialsubTags = productviewcontroller.Bottom_userlist
      ...
      child: Stack(
        ...
        children: [
          ListView.builder(
            ...
            itemCount: productviewcontroller
                    .Bottom_userlist.value.productView?.galleryUrl?.length ??
                0,
            itemBuilder: (BuildContext context, int index) {
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller
                    .Bottom_userlist.value.productView?.galleryUrl?[index] ??
                '';
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size = productviewcontroller.Bottom_userlist.value.productView
      ...
      child: Align(
        ...
        child: SizedBox(
          ...
          child: ListView.separated(
            ...
            itemCount: productviewcontroller.Bottom_userlist.value.productView
                    ?.productDetails?.details!.length ??
                0,
            itemBuilder: (context, index) {
              if (index < 0 ||
                  index >=
                      (productviewcontroller.Bottom_userlist.value.productView!
                              .productDetails?.details!.length ??
                          0)) {
                ...
                child: GestureDetector(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          '${productviewcontroller.Bottom_userlist.value.productView?.productDetails?.details?[index].Size.toString()}',
                          style: TextStyle(
  ...
  /// Section Widget
//   Widget _buildListWidget(BuildContext context) {
// //List<ProductDetails>? productDetails = productviewcontroller.Bottom_userlist.value.productView?.productDetails;
...
//             },
//             itemCount: productviewcontroller
//                     .Bottom_userlist.value.productView?.productDetails?.length ??
//                 0,
//             itemBuilder: (context, index) {
//               if (index < 0 ||
//                   index >=
...
//               String sizeCapacity = productviewcontroller.Bottom_userlist.value
...
//   }
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.Bottom_userlist.value.productReview == null ||
        productviewcontroller
                .Bottom_userlist.value.productReview!.productReviewDetails ==
            null ||
        productviewcontroller.Bottom_userlist.value.productReview!
    ...
    return Container(
      ...
      child: ListView.builder(
        physics: NeverScrollableScrollPhysics(),
        itemCount: productviewcontroller.Bottom_userlist.value.productReview
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.Bottom_userlist
                    ...
                    Text(
                      "${productviewcontroller.Bottom_userlist.value.productReview?.productAverageReview?.toString()}",
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].userImage.toString()}",
                        height: 60.adaptSize,
                        width: 60.adaptSize,
                        radius: BorderRadius.circular(
                          30.h,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'Almarai',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'Almarai',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                ...
                child: CustomRatingBar(
                  initialRating: productviewcontroller.Bottom_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'Almarai',
              ...
              //     return CustomImageView(
              //       imagePath:
              //           "${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
              //       height: 80.adaptSize,
              //       width: 80.adaptSize,
              //       radius: BorderRadius.circular(
              //         8.h,
              ...
              //       );
              //     },
              //     itemCount: productviewcontroller.Bottom_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "مفيد(${productviewcontroller.Bottom_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'Almarai',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          color = productviewcontroller.Bottom_userlist.value.productView
  ...
  Widget _buildSize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.Bottom_userlist.value.productView
              ?.productDetails?.details?[index].Size;
              ...
              onTap: () {
                if (color != null && size1 != null) {
                  ...
                  Arabiccartproductid = productviewcontroller
                      ...
                      .toString();
                  ArabicAddtocartColor = colorId.toString();
                  ArabicAddtocartprice = productviewcontroller.Bottom_userlist
