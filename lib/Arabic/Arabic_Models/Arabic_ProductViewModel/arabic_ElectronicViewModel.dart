class arabic_ElectronicsViewModel {
  arabic_ElectronicsViewModel({
    this.status,
    this.modalCategory,
    this.productView,
    this.productReview,
  ...
  arabic_ElectronicsViewModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Details {
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['Data-Capacity'] = DataCapacity;
    _data['Data-Capacity_id'] = DataCapacityId;
