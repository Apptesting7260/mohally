class HomelivingSubCatFurnitureProductsModel {
  HomelivingSubCatFurnitureProductsModel({
    this.status,
  ...
  HomelivingSubCatFurnitureProductsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
