...
return Scaffold(
appBar:AppBar(
title: Text('معلومات عنا', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'Almarai', ),),
leading: Padding(
...
body:
htmlresponse==null?Center(child: CircularProgressIndicator()):
...
Center(
  child: Directionality(
    ...
    child: Center(
      ...
      child: Container(height: MediaQuery.of(context).size.height,width: MediaQuery.of(context).size.width,child: 
