...
class SinglePageScreen_Electronics_AudioHeadphones extends StatefulWidget {
  const SinglePageScreen_Electronics_AudioHeadphones({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Electronics_AudioHeadphones> createState() =>
      _SinglePageScreen_Electronics_AudioHeadphonesState();
}

class _SinglePageScreen_Electronics_AudioHeadphonesState
    extends State<SinglePageScreen_Electronics_AudioHeadphones> {
              ...
              child: productviewcontroller
                  ...
                  : ListView(
                      ...
                      children: [
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text:
                                                    '${productviewcontroller.headphones_userlist.value.productView!.price}',
                        ...
                        // //         .headphones_userlist.value.productReview !=
                        // //     null)
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
          ...
          physics: NeverScrollableScrollPhysics(),
          itemBuilder: (BuildContext context, int index) {
            color = productviewcontroller.headphones_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.headphones_userlist.value.productView
                  ...
                  if (color != null && size1 != null) {
                    if (colorId == null) {
                      ...
                      EnglishAddtocartprice = productviewcontroller
                          .headphones_userlist.value.productView?.price
                          .toString();
