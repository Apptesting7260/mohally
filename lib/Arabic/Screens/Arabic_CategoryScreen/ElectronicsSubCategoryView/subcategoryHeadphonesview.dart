...
class arabicSubCat_Electronics_headphones extends StatefulWidget {
  const arabicSubCat_Electronics_headphones({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Electronics_headphones> createState() =>
      _arabicSubCat_Electronics_headphonesState();
}

class _arabicSubCat_Electronics_headphonesState
    extends State<arabicSubCat_Electronics_headphones> {
        ...
        child: Obx(() {
          if (_productbycatid_controller.rxRequestStatus.value ==
            ...
            return _productbycatid_controller
                            .headphones_userlist.value.productByCategory ==
                        null ||
                    _productbycatid_controller.headphones_userlist.value
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: _productbycatid_controller.headphones_userlist
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_productbycatid_controller.headphones_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.headphones_userlist.value.productByCategory?[index].aTitle.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_productbycatid_controller.headphones_userlist.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_productbycatid_controller.headphones_userlist.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
