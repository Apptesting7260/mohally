...
class _SearchHistoryArabicState extends State<SearchHistoryArabic> {
 SearchCategories_Controller searchcategories_controller = SearchCategories_Controller();
  ...
  Widget build(BuildContext context) {
    return Obx((){
       if (
        ...
        appBar: 
          AppBar(
            title: Text("يبحث", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'Almarai', ),),
            leading: Padding(
            ...
            children: [
              ...
              searchHistory.clear(); // Remove the search history entry
                ...
                child: Padding(
                  ...
                  child: Icon(Icons.delete, color: Color(0xffff8300),),
                ))
            ],
          ),
          SizedBox(height: Get.height * 0.04),
 ...
 Wrap(
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return AppBar(
         ...
         child :Text( "يبحث", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'Almarai', ),)),
        );
  }
