...
class SinglePageScreen_mens_activewear extends StatefulWidget {
  const SinglePageScreen_mens_activewear({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_mens_activewear> createState() =>
      _SinglePageScreen_mens_activewearState();
}

class _SinglePageScreen_mens_activewearState
    extends State<SinglePageScreen_mens_activewear> {
