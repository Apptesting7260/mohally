...
import 'package:mohally/Arabic/Arabic_controllers/arabic_AllMensProductController.dart';
import 'package:mohally/Arabic/Arabic_controllers/arabic_Allwomenscontroller.dart';
...
import 'package:mohally/Arabic/Arabic_controllers/arabic_allElectronicsProductsController.dart';
...
class Allelectronics_productview extends StatefulWidget {
  const Allelectronics_productview({Key? key}) : super(key: key);

  @override
  State<Allelectronics_productview> createState() =>
      _Allelectronics_productviewState();
}

class _Allelectronics_productviewState
    extends State<Allelectronics_productview> {
  ...
  void initState() {
    ...
    super.initState();
    _allmensproductcontroller.WomensAllProductView();
  }

  List<bool> isButtonTappedList = List.generate(200, (index) => false);
  ArabicWomensAllProductController _allmensproductcontroller =
      ArabicWomensAllProductController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Directionality(
        ...
        child: Obx(() {
          if (_allmensproductcontroller.rxRequestStatus.value ==
              Status.LOADING) {
            return const Scaffold(
              body: Center(child: CircularProgressIndicator()),
            );
          } else if (_allmensproductcontroller.rxRequestStatus.value ==
              Status.ERROR) {
            return Scaffold(
                body: Center(
                    child: Column(
            ...
            return _allmensproductcontroller.womens.value.productByCategory ==
                        null ||
                    _allmensproductcontroller
                            .womens.value.productByCategory?.length ==
                        0
                ? Center(
                    child: Column(
                    children: [
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: _allmensproductcontroller
                              .womens.value.productByCategory?.length ??
                          0,
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_allmensproductcontroller.womens.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                                            _allmensproductcontroller
                                                .womens
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_allmensproductcontroller.womens.value.productByCategory?[index].title.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_allmensproductcontroller.womens.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_allmensproductcontroller.womens.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
                                    ...
                                    onTap: () async {
                                      arabicMainCatId =
                                          _allmensproductcontroller
                                              ...
                                              .toString();
                                      String? arproductId =
                                          _allmensproductcontroller.womens.value
