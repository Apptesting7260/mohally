...
class SinglePageScreen_Mens_Formals extends StatefulWidget {
  const SinglePageScreen_Mens_Formals({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Mens_Formals> createState() =>
      _SinglePageScreen_Mens_FormalsState();
}

class _SinglePageScreen_Mens_FormalsState
    extends State<SinglePageScreen_Mens_Formals> {
