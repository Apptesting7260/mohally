...
class arabic_subcategory_homelivingScreen extends StatefulWidget {
  const arabic_subcategory_homelivingScreen({Key? key}) : super(key: key);

  @override
  State<arabic_subcategory_homelivingScreen> createState() =>
      _arabic_subcategory_homelivingScreenState();
}

class _arabic_subcategory_homelivingScreenState
    extends State<arabic_subcategory_homelivingScreen> {
  @override
  void initState() {
        ...
        child: Obx(() {
          if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
            ...
            return _categoryByName
                            .home_living_userlist.value.seeAllMainCategory ==
                        null ||
                    _categoryByName.home_living_userlist.value
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: _categoryByName.home_living_userlist
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        "${_categoryByName.home_living_userlist.value.seeAllMainCategory?[index].imageUrl.toString()}",
                                        height: 68,
                                        width: 68,
                                        fit: BoxFit.cover,
                                      ),
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                        "${_categoryByName.home_living_userlist.value.seeAllMainCategory?[index].aCategoryName.toString()}",
                                        style: TextStyle(
