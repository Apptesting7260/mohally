...
class ArabicMensActivewearSingleShViewScreen extends StatefulWidget {
  const ArabicMensActivewearSingleShViewScreen({Key? key})
      : super(
          key: key,
        );

  @override
  State<ArabicMensActivewearSingleShViewScreen> createState() =>
      _ArabicMensActivewearSingleShViewScreenState();
}

class _ArabicMensActivewearSingleShViewScreenState
    extends State<ArabicMensActivewearSingleShViewScreen> {
          ...
          child: Scaffold(
            body: Directionality(
              ...
              child: productviewcontroller
                          .activewear_userlist.value.productView ==
                      null
                  ...
                  : SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          // Text(
                          //                       "${productviewcontroller.activewear_userlist.value.productView?.productDetails.toString()}",
                          //                     // "سترة NOBERO للرجال من القطن للسفر بتصميم سادة وغطاء للرأس رياضي شتوي",
                          //                     maxLines: 2,
                          //                     overflow: TextOverflow.ellipsis,
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      '${productviewcontroller.activewear_userlist.value.productView!.productDetails!.details?[index].price.toString()}',
                                                ...
                                                TextSpan(
                                                  text:
                                                      "${productviewcontroller.activewear_userlist.value.productView!.productDetails!.details?[index].productPrice.toString()}",
                                                  style: CustomTextStyles
                          ...
                          SizedBox(height: 14.v),
                          // Obx(() {
                          // var materialTags = productviewcontroller.activewear_userlist
                          //     .value.productView?.productCatgories?.tags;
                          // var materialsubTags = productviewcontroller.activewear_userlist
      ...
      child: Stack(
        ...
        children: [
          ListView.builder(
            ...
            itemCount: productviewcontroller.activewear_userlist.value
          ...
          Align(
            ...
            child: Column(
              ...
              children: [
                ...
                //     context,
                //     selectedImageIndex,
                //     productviewcontroller.activewear_userlist.value
                //             .productView?.galleryUrl?.length ??
                //         0),
                SizedBox(height: 30.v),
                Padding(
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemCount: productviewcontroller
                  .activewear_userlist.value.productView?.galleryUrl?.length ??
              0,
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller.activewear_userlist.value
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size = productviewcontroller.activewear_userlist.value.productView
                ...
                child: GestureDetector(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          '${productviewcontroller.activewear_userlist.value.productView?.productDetails?.details?[index].Size.toString()}',
                          style: TextStyle(
  ...
  /// Section Widget
//   Widget _buildListWidget(BuildContext context) {
// //List<ProductDetails>? productDetails = productviewcontroller.activewear_userlist.value.productView?.productDetails;
...
//             },
//             itemCount: productviewcontroller
//                     .activewear_userlist.value.productView?.productDetails?.length ??
//                 0,
//             itemBuilder: (context, index) {
//               if (index < 0 ||
//                   index >=
//                       (productviewcontroller.activewear_userlist.value.productView
...
//               String sizeCapacity = productviewcontroller.activewear_userlist.value
...
//   }
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          String imageUrl = productviewcontroller
                  .activewear_userlist.value.productView?.galleryUrl?[index] ??
              '';
          return SizedBox(
            height: 80.adaptSize,
            width: 80.adaptSize,
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.activewear_userlist.value.productReview == null ||
        productviewcontroller.activewear_userlist.value.productReview!
    ...
    return Container(
      ...
      child: ListView.builder(
        physics: NeverScrollableScrollPhysics(),
        itemCount: productviewcontroller.activewear_userlist.value.productReview
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.activewear_userlist
                    ...
                    Text(
                      "${productviewcontroller.activewear_userlist.value.productReview?.productAverageReview?.toString()}",
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.activewear_userlist.value.productReview?.productReviewDetails?[index].userImage.toString()}",
                        height: 60.adaptSize,
                        width: 60.adaptSize,
                        radius: BorderRadius.circular(
                          30.h,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.activewear_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'Almarai',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.activewear_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'Almarai',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                ...
                child: CustomRatingBar(
                  initialRating: productviewcontroller.activewear_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.activewear_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'Almarai',
              ...
              //     return CustomImageView(
              //       imagePath:
              //           "${productviewcontroller.activewear_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
              //       height: 80.adaptSize,
              //       width: 80.adaptSize,
              //       radius: BorderRadius.circular(
              //         8.h,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "مفيد(${productviewcontroller.activewear_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'Almarai',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          color = productviewcontroller.activewear_userlist.value.productView
  ...
  Widget _buildSize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.activewear_userlist.value.productView
              ?.productDetails?.details?[index].Size;
                ...
                if (color != null && size1 != null) {
                  if (colorId == null) {
                    ...
                    Arabiccartproductid = productviewcontroller
                        .activewear_userlist.value.productView?.id
                        .toString();
