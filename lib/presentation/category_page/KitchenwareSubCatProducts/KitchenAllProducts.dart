...
class KitchenAllProducts extends StatefulWidget {
  final bool showAppBar;
  const KitchenAllProducts({Key? key, this.showAppBar: true}) : super(key: key);

  @override
  State<KitchenAllProducts> createState() => _KitchenAllProductsState();
}

class _KitchenAllProductsState extends State<KitchenAllProducts> {
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                          .Kitchen_userlist.value.productByCategory ==
                      null ||
                  _productbycatid_controller
                          .Kitchen_userlist.value.productByCategory?.length ==
                      0
              ? NoProductFound(
                  showAppBar: false,
                )
                    ...
                    children: [
                      Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: _productbycatid_controller.Kitchen_userlist
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.Kitchen_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.Kitchen_userlist.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.Kitchen_userlist.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.Kitchen_userlist.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
