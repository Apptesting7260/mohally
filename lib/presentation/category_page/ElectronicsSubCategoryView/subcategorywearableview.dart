...
class SubCat_Electronics_wearable extends StatefulWidget {
  const SubCat_Electronics_wearable({Key? key}) : super(key: key);

  @override
  State<SubCat_Electronics_wearable> createState() =>
      _SubCat_Electronics_wearableState();
}

class _SubCat_Electronics_wearableState
    extends State<SubCat_Electronics_wearable> {
        ...
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                  ...
                  _productbycatid_controller
                          .wearable_userlist.value.productByCategory?.length ==
                      0
              ? Center(
                  child: Column(
                  children: [
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.wearable_userlist.value.productByCategory?[index].title.toString()}",
                                          ...
                                          onTap: () {
                                            ...
                                            if (mainCatId == "173") {
                                              ...
                                              showModalBottomSheet(
                                                  ...
                                                  builder: (context) {
                                                    return _buildAddtocartElectronicsWearable(
                                                        context,
                                                        mainCatId,
                                                        productId);
                                                  });
  ...
  Widget _buildAddtocartElectronicsWearable(
