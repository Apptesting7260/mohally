...
class Kitchen_LargeAppliancesProducts extends StatefulWidget {
  final bool showAppBar;
  const Kitchen_LargeAppliancesProducts({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<Kitchen_LargeAppliancesProducts> createState() =>
      _Kitchen_LargeAppliancesProductsState();
}

class _Kitchen_LargeAppliancesProductsState
    extends State<Kitchen_LargeAppliancesProducts> {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller.Kitchen_largeAppliances_userlist
                          .value.productByCategory ==
                      null ||
                  _productbycatid_controller.Kitchen_largeAppliances_userlist
                      ...
                      Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: _productbycatid_controller
                                  .Kitchen_largeAppliances_userlist
                                  .value
                                  .productByCategory
                                  ?.length ??
                              0,
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.Kitchen_largeAppliances_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.Kitchen_largeAppliances_userlist.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.Kitchen_largeAppliances_userlist.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.Kitchen_largeAppliances_userlist.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
