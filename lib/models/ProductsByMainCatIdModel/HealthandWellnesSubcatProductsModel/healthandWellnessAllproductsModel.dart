class HealthandWellnessAllProductsviewModel {
  HealthandWellnessAllProductsviewModel({
    this.status,
  ...
  HealthandWellnessAllProductsviewModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
