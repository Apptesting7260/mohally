...
class ALLSinglePageScreen_Electronics_AudioHeadphones extends StatefulWidget {
  const ALLSinglePageScreen_Electronics_AudioHeadphones({Key? key})
      : super(
          key: key,
        );

  @override
  State<ALLSinglePageScreen_Electronics_AudioHeadphones> createState() =>
      _ALLSinglePageScreen_Electronics_AudioHeadphonesState();
}

class _ALLSinglePageScreen_Electronics_AudioHeadphonesState
    extends State<ALLSinglePageScreen_Electronics_AudioHeadphones> {
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.headphones_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
          ...
          return CustomOutlinedButton(
            ...
            onPressed: () {
              Englishcartproductid = productviewcontroller
                  .headphones_userlist.value.productView?.id
                  .toString();
              EnglishAddtocartColor = productviewcontroller.headphones_userlist
                  .value.productView?.productDetails?.details?[0].ColorId
                  .toString();
              EnglishAddtocartprice = productviewcontroller.headphones_userlist
                  .value.productView?.productDetails?.details?[index].price
                  .toString();
              EnglishAddtocartSize = productviewcontroller.headphones_userlist
  ...
  Widget _buildcontentofimg1(BuildContext context) {
    return Column(
      children: [
        ...
        ListView.builder(
          shrinkWrap: true,
          itemCount: productviewcontroller.headphones_userlist.value.productView
                  ?.productCatgories?.tags?.item?.length ??
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.headphones_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.headphones_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.headphones_userlist.value
