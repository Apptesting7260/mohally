...
class FurniturecarpetsProducts extends StatefulWidget {
  final bool showAppBar;
  const FurniturecarpetsProducts({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<FurniturecarpetsProducts> createState() =>
      _FurniturecarpetsProductsState();
}

class _FurniturecarpetsProductsState extends State<FurniturecarpetsProducts> {
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                          .furniture_carpets_userlist.value.productByCategory ==
                      null ||
                  _productbycatid_controller.furniture_carpets_userlist.value
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.furniture_carpets_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.furniture_carpets_userlist.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.furniture_carpets_userlist.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.furniture_carpets_userlist.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
