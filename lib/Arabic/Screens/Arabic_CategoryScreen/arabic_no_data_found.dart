  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Container(
            child: Center(child: Image.asset('assets/images/no_product.png',color: Color(0xffff8300),)),
          ),
          Center(child:   Text("No Product Categories Found",style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.normal, fontSize: 12, color: Colors.grey), ),)
        ],
      ),
    );
  }
