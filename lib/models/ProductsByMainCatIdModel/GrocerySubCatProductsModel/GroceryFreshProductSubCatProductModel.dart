class GrocerySubCatFreshProduceProductsModel {
  GrocerySubCatFreshProduceProductsModel({
    this.status,
  ...
  GrocerySubCatFreshProduceProductsModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
