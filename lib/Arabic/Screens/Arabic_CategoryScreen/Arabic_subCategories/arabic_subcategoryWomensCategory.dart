          ...
          child: Obx(() {
            if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
              ...
              return _categoryByName.womens_userlist.value.seeAllMainCategory ==
                          null ||
                      _categoryByName.womens_userlist.value.seeAllMainCategory
                              ?.length ==
                          0
                  ? Center(
                      child: Padding(
                        ...
                        Container(
                          ...
                          child: PageView(
                            ...
                            children: [
                              ...
                              Container(child: arabicSubCat_Womens_Dresses()),
                              Container(child: arabicSubCat_Womens_Tops()),
                            ],
                          ),
                        ),
                      ],
