...
class SubCat_Mens_Bottoms extends StatefulWidget {
  const SubCat_Mens_Bottoms({Key? key}) : super(key: key);

  @override
  State<SubCat_Mens_Bottoms> createState() => _SubCat_Mens_BottomsState();
}

class _SubCat_Mens_BottomsState extends State<SubCat_Mens_Bottoms> {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.Bottom_userlist.value.productByCategory?[index].title.toString()}",
                                    ...
                                    onTap: () {
                                      ...
                                      if (mainCatId == "154") {
                                        ...
                                        showModalBottomSheet(
                                            ...
                                            builder: (context) {
                                              return _buildAddtocartmensBottom(
                                                  context,
                                                  mainCatId,
                                                  productId);
                                            });
  ...
  Widget _buildAddtocartmensBottom(
