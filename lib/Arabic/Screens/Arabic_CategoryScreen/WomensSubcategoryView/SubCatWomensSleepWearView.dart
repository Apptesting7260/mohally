...
class arabicSubCat_Womens_sleepwear extends StatefulWidget {
  const arabicSubCat_Womens_sleepwear({Key? key}) : super(key: key);

  @override
  State<arabicSubCat_Womens_sleepwear> createState() =>
      _arabicSubCat_Womens_sleepwearState();
}

class _arabicSubCat_Womens_sleepwearState
    extends State<arabicSubCat_Womens_sleepwear> {
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.ShirtandTops_userlist.value.productByCategory?[index].aTitle.toString()}",
  ...
  Widget _buildAddtocartWomens_SleepwearView(
