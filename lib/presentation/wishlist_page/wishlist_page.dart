...
class _WishlistPageState extends State<WishlistPage> {
  ...
  EnglishAdd_remove_wishlistController add_remove_wishlistController =EnglishAdd_remove_wishlistController();
@override
void initState() {
  super.initState();
...
viewWishlistcontroller.userList.value.wishlistViewList == null ||
      ...
      ? Center(child: Padding(
        ...
        child: Column(
          children: [
           ...
           Text("Your wishlist is empty!",style: theme.textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.normal, fontSize: 18), ),
            SizedBox(height: Get.height*.01,),
             Text("Explore More and shortlist some items",style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.normal, fontSize: 18, color: Colors.grey), ),
          ],
        ),
      ))
      :Padding(
         ...
         fit: BoxFit.cover,
                ...
                Padding(
                  ...
                  child: CustomIconButton(
                    ...
                    alignment: Alignment.topRight,
                    child:CustomImageView(
        imagePath:   ImageConstant. imgGroup239531// Change this to your tapped image
