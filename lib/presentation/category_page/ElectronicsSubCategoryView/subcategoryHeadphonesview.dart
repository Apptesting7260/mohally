...
class SubCat_Electronics_headphones extends StatefulWidget {
  const SubCat_Electronics_headphones({Key? key}) : super(key: key);

  @override
  State<SubCat_Electronics_headphones> createState() =>
      _SubCat_Electronics_headphonesState();
}

class _SubCat_Electronics_headphonesState
    extends State<SubCat_Electronics_headphones> {
  @override
  void initState() {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.headphones_userlist.value.productByCategory?[index].title.toString()}",
