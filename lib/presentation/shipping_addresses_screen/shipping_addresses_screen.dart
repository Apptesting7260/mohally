...
class _Default_addressState extends State<Default_address> {
  Englishuseraddressviewcontroller viewaddresscontroller =Englishuseraddressviewcontroller();
   @override
      void initState() {
        super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: 
       Obx((){
          if (viewaddresscontroller.rxRequestStatus.value == Status.LOADING) {
        return const Scaffold(
          body: Center(child: CircularProgressIndicator()),
        );
      }  else {
         return  
         viewaddresscontroller.userList.value.userAddress ==  null ||
                                    viewaddresscontroller.userList.value.userAddress?.length ==
                                        0
              ...
              Expanded(
                child: Padding(
                  ...
                  child:  ListView.builder(
                    shrinkWrap: true,
                    itemCount: viewaddresscontroller.userList.value.userAddress!.length ,
  ...
  var result = await Get.to(EditAddress(), arguments: {
    ...
    'country': viewaddresscontroller.userList.value.userAddress![index].country,
    'city': viewaddresscontroller.userList.value.userAddress![index].city,
    'state': viewaddresscontroller.userList.value.userAddress![index].state,
    'zip_code': viewaddresscontroller.userList.value.userAddress![index].zipCode,
    'mobile_number': viewaddresscontroller.userList.value.userAddress![index].mobileNumber,
    ...
    viewaddresscontroller.UseraddressView_apihit();
                              ...
                              Container(
                                ...
                                Text(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color:Colors.black, fontFamily: 'Almarai',)
                                ),
                                  Text(
  ...
  Widget _buildSaveAddressButton(BuildContext context) {
    return CustomElevatedButton(
      ...
      buttonTextStyle: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white),
