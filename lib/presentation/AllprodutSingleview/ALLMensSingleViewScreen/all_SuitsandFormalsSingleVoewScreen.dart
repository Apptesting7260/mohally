...
class AllSinglePageScreen_Mens_Formals extends StatefulWidget {
  const AllSinglePageScreen_Mens_Formals({Key? key})
      : super(
          key: key,
        );

  @override
  State<AllSinglePageScreen_Mens_Formals> createState() =>
      _AllSinglePageScreen_Mens_FormalsState();
}

class _AllSinglePageScreen_Mens_FormalsState
    extends State<AllSinglePageScreen_Mens_Formals> {
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.formal_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
          ...
          return CustomOutlinedButton(
            ...
            onPressed: () {
              Englishcartproductid = productviewcontroller
                  ...
                  .toString();
              EnglishAddtocartColor = productviewcontroller.formal_userlist
                  .value.productView?.productDetails?.details?[0].ColorId
                  .toString();
              EnglishAddtocartprice = productviewcontroller.formal_userlist
                  .value.productView?.productDetails?.details?[index].price
                  .toString();
              EnglishAddtocartSize = productviewcontroller.formal_userlist.value
                  .productView?.productDetails?.details?[0].Size
                  .toString();
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemCount: productviewcontroller.formal_userlist.value.productView
              ...
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.formal_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.formal_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var color = productviewcontroller.formal_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.formal_userlist.value.productView
