...
class SinglePageScreen_Bottoms extends StatefulWidget {
  const SinglePageScreen_Bottoms({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Bottoms> createState() =>
      _SinglePageScreen_BottomsState();
}

class _SinglePageScreen_BottomsState extends State<SinglePageScreen_Bottoms> {
