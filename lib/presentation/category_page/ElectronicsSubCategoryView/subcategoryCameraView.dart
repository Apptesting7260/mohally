...
class SubCat_Electronics_camera extends StatefulWidget {
  final bool showAppBar;

  const SubCat_Electronics_camera({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<SubCat_Electronics_camera> createState() =>
      _SubCat_Electronics_cameraState();
}

class _SubCat_Electronics_cameraState extends State<SubCat_Electronics_camera> {
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.camera_userlist.value.productByCategory?[index].title.toString()}",
