...
class MaincategoryGroceryandPantryScreen extends StatefulWidget {
  const MaincategoryGroceryandPantryScreen({Key? key}) : super(key: key);

  @override
  State<MaincategoryGroceryandPantryScreen> createState() =>
      _MaincategoryGroceryandPantryScreenState();
}

class _MaincategoryGroceryandPantryScreenState
    extends State<MaincategoryGroceryandPantryScreen> {
  @override
  void initState() {
    ...
    return Scaffold(
      body: Obx(() {
        if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
          ...
          return _categoryByName.grocery_userlist.value.seeAllMainCategory ==
                      null ||
                  _categoryByName
                          .grocery_userlist.value.seeAllMainCategory?.length ==
                      0
              ? Center(
                  child: Padding(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: GridView.builder(
                              ...
                              itemCount: _categoryByName.grocery_userlist.value
                                    ...
                                    children: [
                                      AnimatedContainer(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            "${_categoryByName.grocery_userlist.value.seeAllMainCategory?[index].imageUrl.toString()}",
                                            height: 68,
                                            width: 68,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      Center(
                                        child: Text(
                                          "${_categoryByName.grocery_userlist.value.seeAllMainCategory?[index].categoryName.toString()}",
                                          style: TextStyle(
