...
class SinglePageScreen_Electronics_Smartphones extends StatefulWidget {
  const SinglePageScreen_Electronics_Smartphones({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Electronics_Smartphones> createState() =>
      _SinglePageScreen_Electronics_SmartphonesState();
}

class _SinglePageScreen_Electronics_SmartphonesState
    extends State<SinglePageScreen_Electronics_Smartphones> {
