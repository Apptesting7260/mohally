          ...
          child: Scaffold(
            body: Container(
              ...
              child: productviewcontroller
                          .laptops_userlist.value.productView ==
                      null
                  ...
                  : ListView(
                      ...
                      children: [
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text:
                                                    '${productviewcontroller.laptops_userlist.value.productView!.price}',
                        ...
                        // //         .laptops_userlist.value.productReview !=
                        // //     null)
                  ...
                  if (color != null && size1 != null) {
                    if (colorId == null) {
                      ...
                      EnglishAddtocartprice = productviewcontroller
                          .laptops_userlist.value.productView?.price
                          .toString();
