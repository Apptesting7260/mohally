...
class ArabicMensAllProduct extends StatefulWidget {
  const ArabicMensAllProduct({Key? key}) : super(key: key);

  @override
  State<ArabicMensAllProduct> createState() => _ArabicMensAllProductState();
}

class _ArabicMensAllProductState extends State<ArabicMensAllProduct> {
  ...
  void initState() {
    ...
    super.initState();
    _allmensproductcontroller.MensAllProductView();
  }

  List<bool> isButtonTappedList = List.generate(200, (index) => false);
  ArabicMensAllProductController _allmensproductcontroller =
      ArabicMensAllProductController();
      ...
      body: Directionality(
        ...
        child: Obx(() {
          if (_allmensproductcontroller.rxRequestStatus.value ==
            ...
            return _allmensproductcontroller.mens.value.productByCategory ==
                        null ||
                        ...
                        return Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CustomImageView(
                                      fit: BoxFit.cover,
                                      imagePath:
                                          "${_allmensproductcontroller.mens.value.productByCategory?[index].imageUrl.toString()}",
                                      onTap: () {
                                        arabicMainCatId =
                                            _allmensproductcontroller
                                                .mens
                                                ...
                                                .toString();
                                        String? ProductId =
                                            _allmensproductcontroller.mens.value
                            ...
                            SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_allmensproductcontroller.mens.value.productByCategory?[index].title.toString()}",
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${_allmensproductcontroller.mens.value.productByCategory?[index].averageRating.toString()}",
                                            // "4.8",
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${_allmensproductcontroller.mens.value.productByCategory?[index].price.toString()}",
                                          //"\$99 ",
