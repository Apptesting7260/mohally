...
class _SingleProductViewState extends State<SingleProductView> {
          ...
          body: SafeArea(
            child: Container(
              ...
              child: productviewcontroller
                          .HomeLiving_userlist.value.productView ==
                      null
                  // productviewcontroller.HomeLiving_userlist.value
                  //         .productView?.length ==
                  //     0
                  ? Center(
                      child: Padding(
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                              "${productviewcontroller.HomeLiving_userlist.value.productView?.title.toString()}",
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.HomeLiving_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                ...
                                child: Row(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        "${productviewcontroller.HomeLiving_userlist.value.productReview?.productAverageReview.toString()}",
                                        // "4.8",
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            children: [
                                              TextSpan(
                                                text:
                                                    '${productviewcontroller.HomeLiving_userlist.value.productView!.price}',
                                              ...
                                              // TextSpan(
                                              //   text:
                                              //       '${productviewcontroller.HomeLiving_userlist.value.productView!.productDetails!.details?[index].productPrice}',
                                              //   style: CustomTextStyles
                        ...
                        if (productviewcontroller.HomeLiving_userlist.value
                        ...
                        if (productviewcontroller.HomeLiving_userlist.value.productView?.productType == "variable" &&
                            productviewcontroller
                                    .HomeLiving_userlist
                                    .value
                                    .productView
                                ...
                                [])
                          _buildsize(context)
                        else if (productviewcontroller.HomeLiving_userlist.value.productView?.productType ==
                                "variable" &&
                            productviewcontroller
                                    .HomeLiving_userlist
                                    .value
                        ...
                        else if (productviewcontroller.HomeLiving_userlist.value
                                    .productView?.productType ==
                                "variable" &&
                            productviewcontroller.HomeLiving_userlist.value
                                    .productView?.productDetails?.details!.model !=
                                [])
                          _buildmodel(context)
                        else if (productviewcontroller.HomeLiving_userlist.value
                                    .productView?.productType ==
                        ...
                        // //         .HomeLiving_userlist.value.productReview !=
                        // //     null)
                          ...
                          Container(
                            child: Column(
                              children: [
                                ...
                                CustomImageView(
                                  imagePath:
                                      "${productviewcontroller.HomeLiving_userlist.value.productView?.imageUrl.toString()}",
                                  height: Get.height * .4,
                                  width: 335.h,
  ...
  Widget _buildStackSixtyNine(BuildContext context) {
    return Container(
      ...
      child: Stack(
        ...
        children: [
          if (productviewcontroller
                  .HomeLiving_userlist.value.productView!.productType ==
              "variable")
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return CustomImageView(
                        ...
                        imagePath:
                            ...
                            "$imageUrl",
                        // "${productviewcontroller.HomeLiving_userlist.value.productView!.productDetails?.details?.color?[index].gallery ?? ''}",
                        height: 504.v,
                        width: Get.width,
                        alignment: Alignment.center,
                      );
                ...
                : PageView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return CustomImageView(
                        fit: BoxFit.fill,
                        imagePath:
                            "${productviewcontroller.HomeLiving_userlist.value.productView?.imageUrl}",
                        height: 504.v,
                        width: Get.width,
                        alignment: Alignment.center,
                      );
            ...
            PageView.builder(
              controller: _pageController,
              scrollDirection: Axis.horizontal,
              itemCount: productviewcontroller.HomeLiving_userlist.value
              ...
              itemBuilder: (BuildContext context, int index) {
                return CustomImageView(
                  ...
                  imagePath:
                      ...
                      "${productviewcontroller.HomeLiving_userlist.value.productView?.galleryUrl?[index] ?? ''}",
                  height: 504.v,
                  width: Get.width,
                  alignment: Alignment.center,
                );
              ...
              children: [
                ...
                if (productviewcontroller
                  ...
                  _buildButtonOneHundredTen(
                    ...
                    productviewcontroller.HomeLiving_userlist.value.productView
                            ?.galleryUrl?.length ??
                        0,
                    _currentIndex, // Pass the current index
                  ),
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemCount: productviewcontroller
                  .HomeLiving_userlist.value.productView?.galleryUrl?.length ??
              0,
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller.HomeLiving_userlist.value
      ...
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          String imageUrl = productviewcontroller
                  .HomeLiving_userlist.value.productView?.galleryUrl?[index] ??
              '';
          return SizedBox(
            height: Get.height * .1,
            //  width: 80.adaptSize,
  ...
  Widget _buildReview(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        physics: NeverScrollableScrollPhysics(),
        itemCount: productviewcontroller.HomeLiving_userlist.value.productReview
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.HomeLiving_userlist
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.HomeLiving_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'League Spartan',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.HomeLiving_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'League Spartan',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                padding: EdgeInsets.only(left: 20.h),
                child: CustomRatingBar(
                  initialRating: productviewcontroller.HomeLiving_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.HomeLiving_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'League Spartan',
                  ...
                  itemBuilder: (context, index) {
                    if (productviewcontroller
                      ...
                      return SizedBox(
                        ...
                        child: CustomImageView(
                          imagePath:
                              "${productviewcontroller.HomeLiving_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
                          height: 80.adaptSize,
                          width: 80.adaptSize,
                          radius: BorderRadius.circular(
                            8.h,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.HomeLiving_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
          ...
          physics: NeverScrollableScrollPhysics(),
          itemBuilder: (BuildContext context, int index) {
            color = productviewcontroller.HomeLiving_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.HomeLiving_userlist.value.productView
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              if (sizeid != null && colorId != null) {
                                print(sizeid);
                                pid = productviewcontroller
                                    .HomeLiving_userlist.value.productView?.id
                                    .toString();
                                productColor = colorId.toString();
                                // quantity = counter;
                                productSize = sizeid.toString();
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          bool inCart = productviewcontroller
              .HomeLiving_userlist.value.productView!.inCart;
          return Obx(
            () => InkWell(
              onTap: () {
                  ...
                  if (colorId == null) {
                    ...
                    if (!inCart) {
                      ...
                      EnglishAddtocartprice = productviewcontroller
                          .HomeLiving_userlist.value.productView?.price
                          .toString();
