...
class SubCat_Mens_activewear extends StatefulWidget {
  final bool showAppBar;
  const SubCat_Mens_activewear({Key? key, this.showAppBar = true})
      : super(key: key);

  @override
  State<SubCat_Mens_activewear> createState() => _SubCat_Mens_activewearState();
}

class _SubCat_Mens_activewearState extends State<SubCat_Mens_activewear> {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              width: 131.h,
                              child: Text(
                                "${_productbycatid_controller.activewear_userlist.value.productByCategory?[index].title.toString()}",
