...
class MaincategoryHealthAndWellness extends StatefulWidget {
  const MaincategoryHealthAndWellness({Key? key}) : super(key: key);

  @override
  State<MaincategoryHealthAndWellness> createState() =>
      _MaincategoryHealthAndWellnessState();
}

class _MaincategoryHealthAndWellnessState
    extends State<MaincategoryHealthAndWellness> {
  @override
  void initState() {
    ...
    return Scaffold(
      body: Obx(() {
        if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
          ...
          return _categoryByName.healthAndWellness_userlist.value
                          .seeAllMainCategory ==
                      null ||
                  _categoryByName.healthAndWellness_userlist.value
                                    ...
                                    children: [
                                      AnimatedContainer(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            "${_categoryByName.healthAndWellness_userlist.value.seeAllMainCategory?[index].imageUrl.toString()}",
                                            height: 68,
                                            width: 68,
                                            fit: BoxFit.cover,
                                          ),
                                      ...
                                      Center(
                                        child: Text(
                                          "${_categoryByName.healthAndWellness_userlist.value.seeAllMainCategory?[index].categoryName.toString()}",
                                          style: TextStyle(
