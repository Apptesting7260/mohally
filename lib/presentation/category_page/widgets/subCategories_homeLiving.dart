...
class subcategoryHomeLivingScreen extends StatefulWidget {
  const subcategoryHomeLivingScreen({Key? key}) : super(key: key);

  @override
  State<subcategoryHomeLivingScreen> createState() =>
      _subcategoryHomeLivingScreenState();
}

class _subcategoryHomeLivingScreenState
    extends State<subcategoryHomeLivingScreen> {
  @override
  void initState() {
      ...
      body: Obx(() {
        if (_categoryByName.rxRequestStatus.value == Status.LOADING) {
          ...
          return _categoryByName
                      ...
                      null ||
                  _categoryByName.home_living_userlist.value.seeAllMainCategory
                          ?.length ==
                      0
              ? Center(
                  child: Padding(
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                        "${_categoryByName.home_living_userlist.value.seeAllMainCategory?[index].categoryName.toString()}",
                                        style: TextStyle(
