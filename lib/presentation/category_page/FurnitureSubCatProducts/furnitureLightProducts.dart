...
class FurnitureLightsProducts extends StatefulWidget {
  final bool showAppBar;
  const FurnitureLightsProducts({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<FurnitureLightsProducts> createState() =>
      _FurnitureLightsProductsState();
}

class _FurnitureLightsProductsState extends State<FurnitureLightsProducts> {
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                          .furniture_light_userlist.value.productByCategory ==
                      null ||
                  _productbycatid_controller.furniture_light_userlist.value
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.furniture_light_userlist.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.furniture_light_userlist.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.furniture_light_userlist.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.furniture_light_userlist.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
