...
class SubCat_Health_FittnessProductScreen extends StatefulWidget {
  final bool showAppBar;
  const SubCat_Health_FittnessProductScreen({Key? key, this.showAppBar: true})
      : super(key: key);

  @override
  State<SubCat_Health_FittnessProductScreen> createState() =>
      _SubCat_Health_FittnessProductScreenState();
}

class _SubCat_Health_FittnessProductScreenState
    extends State<SubCat_Health_FittnessProductScreen> {
      ...
      body: Obx(() {
        if (_productbycatid_controller.rxRequestStatus.value ==
          ...
          return _productbycatid_controller
                          .healthwellness_fittness.value.productByCategory ==
                      null ||
                  _productbycatid_controller.healthwellness_fittness.value
                              ...
                              children: [
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      CustomImageView(
                                        ...
                                        fit: BoxFit.cover,
                                        imagePath:
                                            "${_productbycatid_controller.healthwellness_fittness.value.productByCategory?[index].imageUrl.toString()}",
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    width: 131.h,
                                    child: Text(
                                      "${_productbycatid_controller.healthwellness_fittness.value.productByCategory?[index].title.toString()}",
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                  "${_productbycatid_controller.healthwellness_fittness.value.productByCategory?[index].averageRating.toString()}",
                                                  // "4.8",
                                                  style: theme
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${_productbycatid_controller.healthwellness_fittness.value.productByCategory?[index].price.toString()}",
                                                  //"99 ",
