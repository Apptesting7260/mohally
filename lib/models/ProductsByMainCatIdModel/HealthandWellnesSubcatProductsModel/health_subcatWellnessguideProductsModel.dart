class HealthandWellnessWellnessGuidesProductsviewModel {
  HealthandWellnessWellnessGuidesProductsviewModel({
    this.status,
  ...
  HealthandWellnessWellnessGuidesProductsviewModel.fromJson(
