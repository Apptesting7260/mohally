class ArabicHealthandWellnessModel {
  ArabicHealthandWellnessModel({
    this.status,
    this.modalCategory,
    this.productView,
    this.productReview,
  ...
  ArabicHealthandWellnessModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Details {
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['Capacity_id'] = CapacityId;
    _data['Quantity'] = Quantity;
    _data['Quantity_id'] = QuantityId;
