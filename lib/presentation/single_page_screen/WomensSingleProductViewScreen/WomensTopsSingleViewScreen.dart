...
class Womens_Tops_SingleView extends StatefulWidget {
  const Womens_Tops_SingleView({Key? key})
      : super(
          key: key,
        );

  @override
  State<Womens_Tops_SingleView> createState() => _Womens_Tops_SingleViewState();
}

class _Womens_Tops_SingleViewState extends State<Womens_Tops_SingleView> {
          ...
          body: SafeArea(
            child: Container(
              ...
              child: productviewcontroller
                          .womenstops_userlist.value.productView ==
                      null
                  // productviewcontroller.womenstops_userlist.value
                  //         .productView?.length ==
                  //     0
                  ? Center(
                      child: Padding(
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.womenstops_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                ...
                                child: Row(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        "${productviewcontroller.womenstops_userlist.value.productReview?.productAverageReview.toString()}",
                                        // "4.8",
      ...
      child: Stack(
        ...
        children: [
          PageView.builder(
            ...
            itemCount: productviewcontroller.womenstops_userlist.value
            ...
            child: Column(
              ...
              children: [
                ...
                _buildButtonOneHundredTen(
                  context,
                  productviewcontroller.womenstops_userlist.value.productView
                          ?.galleryUrl?.length ??
                      0,
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ListView.separated(
          ...
          itemCount: productviewcontroller
                  .womenstops_userlist.value.productView?.galleryUrl?.length ??
              0,
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller.womenstops_userlist.value
      ...
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          String imageUrl = productviewcontroller
                  .womenstops_userlist.value.productView?.galleryUrl?[index] ??
              '';
          return SizedBox(
            height: Get.height * .1,
            //  width: 80.adaptSize,
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.womenstops_userlist.value.productReview == null ||
        productviewcontroller.womenstops_userlist.value.productReview!
    ...
    return Container(
      ...
      child: ListView.builder(
        physics: NeverScrollableScrollPhysics(),
        itemCount: productviewcontroller.womenstops_userlist.value.productReview
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.womenstops_userlist
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.womenstops_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'League Spartan',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.womenstops_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'League Spartan',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                padding: EdgeInsets.only(left: 20.h),
                child: CustomRatingBar(
                  initialRating: productviewcontroller.womenstops_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.womenstops_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'League Spartan',
                  ...
                  itemBuilder: (context, index) {
                    if (productviewcontroller
                      ...
                      return SizedBox(
                        ...
                        child: CustomImageView(
                          imagePath:
                              "${productviewcontroller.womenstops_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
                          height: 80.adaptSize,
                          width: 80.adaptSize,
                          radius: BorderRadius.circular(
                            8.h,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.womenstops_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          color = productviewcontroller.womenstops_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.womenstops_userlist.value.productView
                  ...
                  if (color != null && size1 != null) {
                    if (colorId == null) {
                      ...
                      Englishcartproductid = productviewcontroller
                          .womenstops_userlist.value.productView?.id
                          .toString();
