...
class SinglePageScreen_Mens_Shoes extends StatefulWidget {
  const SinglePageScreen_Mens_Shoes({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Mens_Shoes> createState() =>
      _SinglePageScreen_Mens_ShoesState();
}

class _SinglePageScreen_Mens_ShoesState
    extends State<SinglePageScreen_Mens_Shoes> {
