    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: productviewcontroller.camera_userlist.value.productReview
            ...
            0,
        itemBuilder: (BuildContext context, int index) {
          String imageUrl = productviewcontroller.camera_userlist.value
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        physics: NeverScrollableScrollPhysics(),
        itemBuilder: (BuildContext context, int index) {
          color = productviewcontroller.camera_userlist.value.productView
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.camera_userlist.value.productView
