...
class AllSinglePageScreen_Mens_Shoes extends StatefulWidget {
  const AllSinglePageScreen_Mens_Shoes({Key? key})
      : super(
          key: key,
        );

  @override
  State<AllSinglePageScreen_Mens_Shoes> createState() =>
      _AllSinglePageScreen_Mens_ShoesState();
}

class _AllSinglePageScreen_Mens_ShoesState
    extends State<AllSinglePageScreen_Mens_Shoes> {
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 15),
                          child: Text(
                              "${productviewcontroller.mensshoes_userlist.value.productView?.slug.toString()}",
                              // "NOBERO Men's Cotton Travel Solid Hooded Winter Sports Jacket",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
  ...
  Widget _buildcontentofimg1(BuildContext context) {
    return Column(
      children: [
        ...
        ListView.builder(
          shrinkWrap: true,
          itemCount: productviewcontroller.mensshoes_userlist.value.productView
                  ?.productCatgories?.tags?.item?.length ??
              0,
          itemBuilder: (context, index) {
            var materialTags = productviewcontroller.mensshoes_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "Helpful(${productviewcontroller.mensshoes_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'League Spartan',
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size1 = productviewcontroller.mensshoes_userlist.value.productView
