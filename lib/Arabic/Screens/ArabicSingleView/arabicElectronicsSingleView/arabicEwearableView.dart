...
class ArabicElectronicswearableSingleShViewScreen extends StatefulWidget {
  const ArabicElectronicswearableSingleShViewScreen({Key? key})
      : super(
          key: key,
        );

  @override
  State<ArabicElectronicswearableSingleShViewScreen> createState() =>
      _ArabicElectronicswearableSingleShViewScreenState();
}

class _ArabicElectronicswearableSingleShViewScreenState
    extends State<ArabicElectronicswearableSingleShViewScreen> {
          ...
          child: Scaffold(
            body: Directionality(
              ...
              child: productviewcontroller
                          .wearable_userlist.value.productView ==
                      null
                  // productviewcontroller.wearable_userlist.value
                  //         .productView?.length ==
                  //     0
                  ? Center(
                      child: Column(
                  ...
                  : SizedBox(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          // Text(
                          //                       "${productviewcontroller.wearable_userlist.value.productView?.productDetails.toString()}",
                          //                     // "سترة NOBERO للرجال من القطن للسفر بتصميم سادة وغطاء للرأس رياضي شتوي",
                          //                     maxLines: 2,
                          //                     overflow: TextOverflow.ellipsis,
                                          ...
                                          RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      '${productviewcontroller.wearable_userlist.value.productView!.productDetails!.details?[index].price.toString()}',
                                                ...
                                                TextSpan(
                                                  text:
                                                      "${productviewcontroller.wearable_userlist.value.productView!.productDetails!.details?[index].productPrice.toString()}",
                                                  style: CustomTextStyles
                          ...
                          SizedBox(height: 14.v),
                          // Obx(() {
                          // var materialTags = productviewcontroller.wearable_userlist
                          //     .value.productView?.productCatgories?.tags;
                          // var materialsubTags = productviewcontroller.wearable_userlist
      ...
      child: Stack(
        ...
        children: [
          ListView.builder(
            ...
            itemCount: productviewcontroller
                    .wearable_userlist.value.productView?.galleryUrl?.length ??
                0,
            itemBuilder: (BuildContext context, int index) {
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            String imageUrl = productviewcontroller
                    .wearable_userlist.value.productView?.galleryUrl?[index] ??
                '';
  ...
  Widget _buildsize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          var size = productviewcontroller.wearable_userlist.value.productView
      ...
      child: Align(
        ...
        child: SizedBox(
          ...
          child: ListView.separated(
            ...
            itemCount: productviewcontroller.wearable_userlist.value.productView
                ...
                child: GestureDetector(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          '${productviewcontroller.wearable_userlist.value.productView?.productDetails?.details?[index].Model.toString()}',
                          style: TextStyle(
  ...
  /// Section Widget
//   Widget _buildListWidget(BuildContext context) {
// //List<ProductDetails>? productDetails = productviewcontroller.wearable_userlist.value.productView?.productDetails;
...
//             },
//             itemCount: productviewcontroller
//                     .wearable_userlist.value.productView?.productDetails?.length ??
//                 0,
//             itemBuilder: (context, index) {
//               if (index < 0 ||
//                   index >=
//                       (productviewcontroller.wearable_userlist.value.productView
...
//               String sizeCapacity = productviewcontroller.wearable_userlist.value
...
//   }
  ...
  Widget _buildReview(BuildContext context) {
    if (productviewcontroller.wearable_userlist.value.productReview == null ||
        productviewcontroller
                .wearable_userlist.value.productReview!.productReviewDetails ==
            null ||
        productviewcontroller.wearable_userlist.value.productReview!
    ...
    return Container(
      ...
      child: ListView.builder(
        physics: NeverScrollableScrollPhysics(),
        itemCount: productviewcontroller.wearable_userlist.value.productReview
          ...
          return Column(
            ...
            children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: CustomRatingBar(
                        initialRating: productviewcontroller.wearable_userlist
                    ...
                    Text(
                      "${productviewcontroller.wearable_userlist.value.productReview?.productAverageReview?.toString()}",
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomImageView(
                        imagePath:
                            "${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].userImage.toString()}",
                        height: 60.adaptSize,
                        width: 60.adaptSize,
                        radius: BorderRadius.circular(
                          30.h,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            "${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].userName.toString()}",
                            style: TextStyle(
                                fontFamily: 'Almarai',
                                fontSize: 11,
                                fontWeight: FontWeight.w400,
                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  "${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].reviewDate.toString()}",
                                  style: TextStyle(
                                      fontFamily: 'Almarai',
                                      fontSize: 11,
                                      fontWeight: FontWeight.w400,
              ...
              Padding(
                ...
                child: CustomRatingBar(
                  initialRating: productviewcontroller.wearable_userlist.value
              ...
              Container(
                ...
                child: Text(
                    "${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].description.toString()}",
                    maxLines: 4,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        fontFamily: 'Almarai',
              ...
              //     return CustomImageView(
              //       imagePath:
              //           "${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].galleryUrl.toString()}",
              //       height: 80.adaptSize,
              //       width: 80.adaptSize,
              //       radius: BorderRadius.circular(
              //         8.h,
              ...
              //       );
              //     },
              //     itemCount: productviewcontroller.wearable_userlist.value
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 4.h),
                      child: Text(
                          "مفيد(${productviewcontroller.wearable_userlist.value.productReview?.productReviewDetails?[index].helpful.toString()})",
                          style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w400,
                              fontFamily: 'Almarai',
  ...
  _buildColors(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          color = productviewcontroller.wearable_userlist.value.productView
  ...
  Widget _buildSize(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: 1,
        itemBuilder: (BuildContext context, int index) {
          size1 = productviewcontroller.wearable_userlist.value.productView
              ?.productDetails?.details?[index].Model;
