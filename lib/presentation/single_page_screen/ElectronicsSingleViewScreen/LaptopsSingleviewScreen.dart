...
class SinglePageScreen_Electronics_Laptops extends StatefulWidget {
  const SinglePageScreen_Electronics_Laptops({Key? key})
      : super(
          key: key,
        );

  @override
  State<SinglePageScreen_Electronics_Laptops> createState() =>
      _SinglePageScreen_Electronics_LaptopsState();
}

class _SinglePageScreen_Electronics_LaptopsState
    extends State<SinglePageScreen_Electronics_Laptops> {
